 ...
 */
 ...
 AND periodid IN (SELECT DISTINCT(ps.periodid) FROM _periodstructure ps,period p WHERE quarterly=(SELECT quarterly FROM _periodstructure WHERE periodid=3459694) AND ps.periodid=p.periodid AND p.periodtypeid=3)
...
/*Female*/
 ...
 AND periodid=(SELECT ps.periodid FROM _periodstructure ps WHERE iso=(SELECT quarterly FROM _periodstructure WHERE periodid=3459694))
...
/*10-14*/
 ...
 AND categoryoptioncomboid IN (565851,21861)
 AND attributeoptioncomboid=184430 AND periodid IN (SELECT DISTINCT(ps.periodid) FROM _periodstructure ps,period p WHERE quarterly=(SELECT quarterly FROM _periodstructure WHERE periodid=3459694) AND ps.periodid=p.periodid AND p.periodtypeid=3)
...
AND periodid=(SELECT ps.periodid FROM _periodstructure ps WHERE iso=(SELECT sixmonthlyapril FROM _periodstructure WHERE periodid=3459694))
...
AND periodid IN (SELECT distinct(ps.periodid) FROM _periodstructure ps, period p WHERE sixmonthlyapril=(SELECT sixmonthlyapril FROM _periodstructure WHERE periodid=3459694) AND ps.periodid=p.periodid AND p.periodtypeid=3)
...
----------------------------------------------------------------------------------------
 ...
 AND periodid=(SELECT ps.periodid FROM _periodstructure ps WHERE iso=(SELECT financialoct FROM _periodstructure WHERE periodid=3459694))
 ...
 AND periodid IN (SELECT distinct(ps.periodid) FROM _periodstructure ps, period p WHERE financialoct=(SELECT financialoct FROM _periodstructure WHERE periodid=3459694) AND ps.periodid=p.periodid AND p.periodtypeid=3)

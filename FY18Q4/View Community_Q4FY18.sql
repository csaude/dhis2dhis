...
left outer join organisationunit district
  ...
  and attributeoptioncomboid=132044 and periodid IN (select distinct(ps.periodid) from _periodstructure ps, period p where quarterly=(SELECT quarterly from _periodstructure where periodid=599888) and ps.periodid=p.periodid and p.periodtypeid=3)
...
/*10-14*/
  ...
  where dataelementid=43327
  and categoryoptioncomboid IN (21837,21861)
  and attributeoptioncomboid=132045 and periodid IN (select distinct(ps.periodid) from _periodstructure ps, period p where quarterly=(SELECT quarterly from _periodstructure where periodid=599888) and ps.periodid=p.periodid and p.periodtypeid=3)

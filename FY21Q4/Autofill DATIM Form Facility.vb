...
Else
    ...
    IE.Document.GetElementByID("selectedPeriodId").Value = "2021Q3"
    IE.Document.GetElementByID("selectedPeriodId").dispatchEvent evt
    'Funding Mechanism
    Application.Wait Now + TimeValue("00:00:03")
    IE.Document.GetElementByID("category-SH885jaRe0o").Value = "hsSJL6DRXoi"
    IE.Document.GetElementByID("category-SH885jaRe0o").dispatchEvent evt
    ...
    'Application.Wait Now + TimeValue("00:00:03")
    'Semiannualy
    'NOT REPORTED ANY MORE SINCE Q4FY21'
    'Call SC_ARVDISP
    'Call SC_CURR

    'Annually
    'HRH NOT REPORTED ANY MORE SINCE Q4FY21'
    'Call HRH
    Call LAB_PTCQI

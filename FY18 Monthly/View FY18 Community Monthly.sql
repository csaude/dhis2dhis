...
left outer join organisationunit district
  ...
  and attributeoptioncomboid=132044 and periodid= (select periodid from _periodstructure where iso=CAST(${monthly} AS text))
...
/*10-14*/
  ...
  where dataelementid=43327
  and categoryoptioncomboid IN (21837,21861)
  and attributeoptioncomboid=132045 and periodid= (select periodid from _periodstructure where iso=CAST(${monthly} AS text))

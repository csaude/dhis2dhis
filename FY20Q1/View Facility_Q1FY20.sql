 ...
 */
 ...
 AND periodid IN (SELECT DISTINCT(ps.periodid) FROM _periodstructure ps,period p WHERE quarterly=(SELECT quarterly FROM _periodstructure WHERE periodid=1582247) AND ps.periodid=p.periodid AND p.periodtypeid=3)
...
/*Female*/
 ...
 AND periodid=(SELECT ps.periodid FROM _periodstructure ps WHERE iso=(SELECT quarterly FROM _periodstructure WHERE periodid=1582247))
...
/*10-14*/
 ...
 AND categoryoptioncomboid IN (565851,21861)
 AND attributeoptioncomboid=184430 AND periodid IN (SELECT DISTINCT(ps.periodid) FROM _periodstructure ps,period p WHERE quarterly=(SELECT quarterly FROM _periodstructure WHERE periodid=1582247) AND ps.periodid=p.periodid AND p.periodtypeid=3)

...
If WorksheetFunction.IsNA(ThisWorkbook.Sheets("sheet1").Range("ABT10")) Or IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ABT10")) Then
...
Else
    ...
    Call IE.Document.parentWindow.execScript("javascript:void selection.select( '" & ThisWorkbook.Sheets("sheet1").Range("ABT10") & "' )", "JavaScript")
    startTime2 = Now
    Application.Wait Now + TimeValue("00:00:30")
...
Application.Wait Now + TimeValue("00:00:0" & Int ((4 - 2 + 1) * Rnd + 2))
'<PWID Negativos

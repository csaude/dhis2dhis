...
'Protection of macros execution
    ...
    Ans = False
        If Not InputBox("Por favor, introduza o password, e certifique que ja fez Login na plataforma DATIM utilizando o internet explorer, deve ser um utilizador com previlegio de Entrada de Dados.", "Entrar Password") = Pword Then
            Ans = True
        If MsgBox("Sem a password ṇo pode efectuar esta opera̤̣o. Por favor! Para mais informa̵̤es contacte o Departamento de Informa̤̣o Estrat̩gica da FGH.", vbOKOnly, "Informa̤̣o") = vbOK Then Exit Sub
        End If
...
If WorksheetFunction.IsNA(ThisWorkbook.Sheets("sheet1").Range("AUR10")) Or IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AUR10")) Then
...
Else
    ...
    Call IE.Document.parentWindow.execScript("javascript:void selection.select( '" & ThisWorkbook.Sheets("sheet1").Range("AUR10") & "' )", "JavaScript")
    startTime2 = Now
    Application.Wait Now + TimeValue("00:00:30")
...
'& ", Dura̤̣o: " & Format(fillDuration, "hh") & ":" & Format(fillDuration, "nn:ss")
...
'<Unknown age Female
IE.Document.GetElementByID("IvI3KbJILcD-CnCOKuBaboa-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-CnCOKuBaboa-val").Value = ThisWorkbook.Sheets("sheet1").Range("MN10")
IE.Document.GetElementByID("IvI3KbJILcD-CnCOKuBaboa-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))

'<10-14 Female
IE.Document.GetElementByID("IvI3KbJILcD-vpJXRljbooI-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-vpJXRljbooI-val").Value = ThisWorkbook.Sheets("sheet1").Range("MO10")
...
IE.Document.GetElementByID("IvI3KbJILcD-nN1BTeF5WuG-val").Value = ThisWorkbook.Sheets("sheet1").Range("MP10")
...
IE.Document.GetElementByID("IvI3KbJILcD-NyElGSpWLWv-val").Value = ThisWorkbook.Sheets("sheet1").Range("MQ10")
...
IE.Document.GetElementByID("IvI3KbJILcD-ptqjXkxioQB-val").Value = ThisWorkbook.Sheets("sheet1").Range("MR10")
...
IE.Document.GetElementByID("IvI3KbJILcD-sQ2iBuN22yj-val").Value = ThisWorkbook.Sheets("sheet1").Range("MS10")
...
IE.Document.GetElementByID("IvI3KbJILcD-U65bkLSdUp7-val").Value = ThisWorkbook.Sheets("sheet1").Range("MT10")
...
IE.Document.GetElementByID("IvI3KbJILcD-U9RGD1yB6AS-val").Value = ThisWorkbook.Sheets("sheet1").Range("MU10")
...
IE.Document.GetElementByID("IvI3KbJILcD-UEccZfdUNLf-val").Value = ThisWorkbook.Sheets("sheet1").Range("MV10")
...
IE.Document.GetElementByID("IvI3KbJILcD-m9JzOvqcfIX-val").Value = ThisWorkbook.Sheets("sheet1").Range("MW10")
IE.Document.GetElementByID("IvI3KbJILcD-m9JzOvqcfIX-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))

'<Unknown age Male
IE.Document.GetElementByID("IvI3KbJILcD-NlZaAUxXJlN-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-NlZaAUxXJlN-val").Value = ThisWorkbook.Sheets("sheet1").Range("MX10")
IE.Document.GetElementByID("IvI3KbJILcD-NlZaAUxXJlN-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))

'<10-14 Male
IE.Document.GetElementByID("IvI3KbJILcD-WvcKCUGBlWW-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-WvcKCUGBlWW-val").Value = ThisWorkbook.Sheets("sheet1").Range("MY10")
...
IE.Document.GetElementByID("IvI3KbJILcD-Mvt3gRxWbl8-val").Value = ThisWorkbook.Sheets("sheet1").Range("MZ10")
...
IE.Document.GetElementByID("IvI3KbJILcD-wS6c6pKnBzB-val").Value = ThisWorkbook.Sheets("sheet1").Range("NA10")
...
IE.Document.GetElementByID("IvI3KbJILcD-cakoLejWzwq-val").Value = ThisWorkbook.Sheets("sheet1").Range("NB10")
...
IE.Document.GetElementByID("IvI3KbJILcD-RZKQIoa9koW-val").Value = ThisWorkbook.Sheets("sheet1").Range("NC10")
...
IE.Document.GetElementByID("IvI3KbJILcD-GoGACmQl6uY-val").Value = ThisWorkbook.Sheets("sheet1").Range("ND10")
...
IE.Document.GetElementByID("IvI3KbJILcD-iUqbs9vu7Uu-val").Value = ThisWorkbook.Sheets("sheet1").Range("NE10")
...
IE.Document.GetElementByID("IvI3KbJILcD-gqPrEjurqem-val").Value = ThisWorkbook.Sheets("sheet1").Range("NF10")
...
IE.Document.GetElementByID("IvI3KbJILcD-X7NYFk3xhP8-val").Value = ThisWorkbook.Sheets("sheet1").Range("NG10")
...
'<Unknown age Female
IE.Document.GetElementByID("IvI3KbJILcD-wlSeTcdsIXl-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-wlSeTcdsIXl-val").Value = ThisWorkbook.Sheets("sheet1").Range("NH10")
IE.Document.GetElementByID("IvI3KbJILcD-wlSeTcdsIXl-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))


'<10-14 Female
IE.Document.GetElementByID("IvI3KbJILcD-ZlfvMsPqqmT-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-ZlfvMsPqqmT-val").Value = ThisWorkbook.Sheets("sheet1").Range("NI10")
...
IE.Document.GetElementByID("IvI3KbJILcD-tbwp7QwAXxa-val").Value = ThisWorkbook.Sheets("sheet1").Range("NJ10")
...
IE.Document.GetElementByID("IvI3KbJILcD-mOXqNYPrtUD-val").Value = ThisWorkbook.Sheets("sheet1").Range("NK10")
...
IE.Document.GetElementByID("IvI3KbJILcD-Y5oW92HtesZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("NL10")
...
IE.Document.GetElementByID("IvI3KbJILcD-onyrqPv9KNE-val").Value = ThisWorkbook.Sheets("sheet1").Range("NM10")
...
IE.Document.GetElementByID("IvI3KbJILcD-d20MZrn4Eln-val").Value = ThisWorkbook.Sheets("sheet1").Range("NN10")
...
IE.Document.GetElementByID("IvI3KbJILcD-k7RAtvkyMUR-val").Value = ThisWorkbook.Sheets("sheet1").Range("NO10")
...
IE.Document.GetElementByID("IvI3KbJILcD-VPru2f26ZSB-val").Value = ThisWorkbook.Sheets("sheet1").Range("NP10")
...
IE.Document.GetElementByID("IvI3KbJILcD-FrSv7fuPqvi-val").Value = ThisWorkbook.Sheets("sheet1").Range("NQ10")
IE.Document.GetElementByID("IvI3KbJILcD-FrSv7fuPqvi-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))


'<Unknown age Female
IE.Document.GetElementByID("IvI3KbJILcD-w1VM3WGD26n-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-w1VM3WGD26n-val").Value = ThisWorkbook.Sheets("sheet1").Range("NR10")
IE.Document.GetElementByID("IvI3KbJILcD-w1VM3WGD26n-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))


'<10-14 Male
IE.Document.GetElementByID("IvI3KbJILcD-ey60Eh4RyK9-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-ey60Eh4RyK9-val").Value = ThisWorkbook.Sheets("sheet1").Range("NS10")
...
IE.Document.GetElementByID("IvI3KbJILcD-rEyueo9TR84-val").Value = ThisWorkbook.Sheets("sheet1").Range("NT10")
...
IE.Document.GetElementByID("IvI3KbJILcD-iPgWd22TJoU-val").Value = ThisWorkbook.Sheets("sheet1").Range("NU10")
...
IE.Document.GetElementByID("IvI3KbJILcD-yrwFtriUxF7-val").Value = ThisWorkbook.Sheets("sheet1").Range("NV10")
...
IE.Document.GetElementByID("IvI3KbJILcD-QKbiiiEUYIO-val").Value = ThisWorkbook.Sheets("sheet1").Range("NW10")
...
IE.Document.GetElementByID("IvI3KbJILcD-F3VzQk7J54W-val").Value = ThisWorkbook.Sheets("sheet1").Range("NX10")
...
IE.Document.GetElementByID("IvI3KbJILcD-O9nOl3oQyBF-val").Value = ThisWorkbook.Sheets("sheet1").Range("NY10")
...
IE.Document.GetElementByID("IvI3KbJILcD-Oyo1mxlQwOh-val").Value = ThisWorkbook.Sheets("sheet1").Range("NZ10")
...
IE.Document.GetElementByID("IvI3KbJILcD-yy0VIRCYJy9-val").Value = ThisWorkbook.Sheets("sheet1").Range("OA10")
IE.Document.GetElementByID("IvI3KbJILcD-yy0VIRCYJy9-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))

'<Unknown Sex
IE.Document.GetElementByID("IvI3KbJILcD-ZUGNLPSJQ5Q-val").Focus
IE.Document.GetElementByID("IvI3KbJILcD-ZUGNLPSJQ5Q-val").Value = ThisWorkbook.Sheets("sheet1").Range("OB10")
IE.Document.GetElementByID("IvI3KbJILcD-ZUGNLPSJQ5Q-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))
...
IE.Document.GetElementByID("CfSIX5yTSdw-cVQALQbbdeJ-val").Value = ThisWorkbook.Sheets("sheet1").Range("OC10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-lm6WNi1cnU4-val").Value = ThisWorkbook.Sheets("sheet1").Range("OH10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-jEDTO4WJAzl-val").Value = ThisWorkbook.Sheets("sheet1").Range("OD10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-t4teq5No1lb-val").Value = ThisWorkbook.Sheets("sheet1").Range("OI10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-URR9fz0msKi-val").Value = ThisWorkbook.Sheets("sheet1").Range("OE10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-tR1agKinTUi-val").Value = ThisWorkbook.Sheets("sheet1").Range("OJ10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-oT1KinoX60T-val").Value = ThisWorkbook.Sheets("sheet1").Range("OF10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-UpkVZP5xLHK-val").Value = ThisWorkbook.Sheets("sheet1").Range("OK10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-z9AHJ7VXAUI-val").Value = ThisWorkbook.Sheets("sheet1").Range("OG10")
...
IE.Document.GetElementByID("CfSIX5yTSdw-bZVkZBLtX1i-val").Value = ThisWorkbook.Sheets("sheet1").Range("OL10")
...
IE.Document.GetElementByID("ovQaECwOS1M-mYMRmrtoxVn-val").Value = ThisWorkbook.Sheets("sheet1").Range("OM10")
...
IE.Document.GetElementByID("ovQaECwOS1M-loZmPoGpvEZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ON10")
...
IE.Document.GetElementByID("ovQaECwOS1M-fPFQkPZwhi8-val").Value = ThisWorkbook.Sheets("sheet1").Range("OO10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("OQ10")) Then
'Numerator
'10-14,F,KP
IE.Document.GetElementByID("fg53NvKg3EN-VAzPX0jofbR-val").Focus
IE.Document.GetElementByID("fg53NvKg3EN-VAzPX0jofbR-val").Value = ThisWorkbook.Sheets("sheet1").Range("OQ10")
...
IE.Document.GetElementByID("fg53NvKg3EN-lno7KOoC6A6-val").Value = ThisWorkbook.Sheets("sheet1").Range("OR10")
...
IE.Document.GetElementByID("fg53NvKg3EN-t6J1nthxMhI-val").Value = ThisWorkbook.Sheets("sheet1").Range("OS10")
...
IE.Document.GetElementByID("fg53NvKg3EN-lQcycFNg0rl-val").Value = ThisWorkbook.Sheets("sheet1").Range("OT10")
...
IE.Document.GetElementByID("fg53NvKg3EN-niWaVaEzwro-val").Value = ThisWorkbook.Sheets("sheet1").Range("OU10")
...
IE.Document.GetElementByID("fg53NvKg3EN-v1SkxpwKWND-val").Value = ThisWorkbook.Sheets("sheet1").Range("OV10")
...
IE.Document.GetElementByID("fg53NvKg3EN-HKWsaDC3VlV-val").Value = ThisWorkbook.Sheets("sheet1").Range("OW10")
...
IE.Document.GetElementByID("fg53NvKg3EN-M1YseWnfCmm-val").Value = ThisWorkbook.Sheets("sheet1").Range("OX10")
...
IE.Document.GetElementByID("fg53NvKg3EN-jzATmmu61Pq-val").Value = ThisWorkbook.Sheets("sheet1").Range("OY10")
...
IE.Document.GetElementByID("fg53NvKg3EN-E6ivU7AttrG-val").Value = ThisWorkbook.Sheets("sheet1").Range("OZ10")
...
IE.Document.GetElementByID("fg53NvKg3EN-aDO5rKzIUjj-val").Value = ThisWorkbook.Sheets("sheet1").Range("PA10")
...
IE.Document.GetElementByID("fg53NvKg3EN-mFpk2mIJQzt-val").Value = ThisWorkbook.Sheets("sheet1").Range("PB10")
...
IE.Document.GetElementByID("RHN2Ui10Ivu-QazyoPSt2XH-val").Value = ThisWorkbook.Sheets("sheet1").Range("PD10")
...
IE.Document.GetElementByID("RHN2Ui10Ivu-UN0vy0VSyHQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("PE10")
...
IE.Document.GetElementByID("RHN2Ui10Ivu-zCrKbLh9x6i-val").Value = ThisWorkbook.Sheets("sheet1").Range("PF10")
...
IE.Document.GetElementByID("RHN2Ui10Ivu-AkOKGZjTuJH-val").Value = ThisWorkbook.Sheets("sheet1").Range("PG10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("PI10")) Then
'EID
'0-2
IE.Document.GetElementByID("I9vfJMV5x7A-TRTNKzpystS-val").Focus
IE.Document.GetElementByID("I9vfJMV5x7A-TRTNKzpystS-val").Value = ThisWorkbook.Sheets("sheet1").Range("PI10")
...
IE.Document.GetElementByID("I9vfJMV5x7A-El4ysmXTL9r-val").Value = ThisWorkbook.Sheets("sheet1").Range("PJ10")
...
IE.Document.GetElementByID("y1sRrKaPeKe-VG9llDXZfqR-val").Value = ThisWorkbook.Sheets("sheet1").Range("PL10")
...
IE.Document.GetElementByID("y1sRrKaPeKe-liIscF6uc2E-val").Value = ThisWorkbook.Sheets("sheet1").Range("PM10")
...
IE.Document.GetElementByID("XuHtzXGDS00-oYuICUnILbz-val").Value = ThisWorkbook.Sheets("sheet1").Range("PN10")
...
IE.Document.GetElementByID("XuHtzXGDS00-bZ4b1EW7Uw7-val").Value = ThisWorkbook.Sheets("sheet1").Range("PO10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("PQ10")) Then
'Known Positives
'<1,F,KP
IE.Document.GetElementByID("tnthrE5AclR-SJ6ny6KglYz-val").Focus
IE.Document.GetElementByID("tnthrE5AclR-SJ6ny6KglYz-val").Value = ThisWorkbook.Sheets("sheet1").Range("PQ10")
...
IE.Document.GetElementByID("tnthrE5AclR-lS34HFr7wcT-val").Value = ThisWorkbook.Sheets("sheet1").Range("PR10")
...
IE.Document.GetElementByID("tnthrE5AclR-iqG5y4IclYv-val").Value = ThisWorkbook.Sheets("sheet1").Range("PS10")
...
IE.Document.GetElementByID("tnthrE5AclR-vHcPl7i3ldt-val").Value = ThisWorkbook.Sheets("sheet1").Range("PT10")
...
IE.Document.GetElementByID("tnthrE5AclR-ljbRunlmafF-val").Value = ThisWorkbook.Sheets("sheet1").Range("PU10")
...
IE.Document.GetElementByID("tnthrE5AclR-Fv4AnNRCi8b-val").Value = ThisWorkbook.Sheets("sheet1").Range("PV10")
...
IE.Document.GetElementByID("tnthrE5AclR-nr8KgqTWYe8-val").Value = ThisWorkbook.Sheets("sheet1").Range("PW10")
...
IE.Document.GetElementByID("tnthrE5AclR-X9oQCOXFLpS-val").Value = ThisWorkbook.Sheets("sheet1").Range("PX10")
...
IE.Document.GetElementByID("tnthrE5AclR-jVLZPId7wiX-val").Value = ThisWorkbook.Sheets("sheet1").Range("PY10")
...
IE.Document.GetElementByID("tnthrE5AclR-R0YTc9AapF2-val").Value = ThisWorkbook.Sheets("sheet1").Range("PZ10")
...
IE.Document.GetElementByID("tnthrE5AclR-ivu836qG5iQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("QA10")
...
IE.Document.GetElementByID("tnthrE5AclR-JV0F6TJ0vRu-val").Value = ThisWorkbook.Sheets("sheet1").Range("QB10")
...
IE.Document.GetElementByID("tnthrE5AclR-rbhnf7MLIGp-val").Value = ThisWorkbook.Sheets("sheet1").Range("QC10")
...
IE.Document.GetElementByID("tnthrE5AclR-VrVDyUAH0Ee-val").Value = ThisWorkbook.Sheets("sheet1").Range("QD10")
...
IE.Document.GetElementByID("tnthrE5AclR-dzXe1VrUu9f-val").Value = ThisWorkbook.Sheets("sheet1").Range("QE10")
...
IE.Document.GetElementByID("tnthrE5AclR-rutEzItUoZs-val").Value = ThisWorkbook.Sheets("sheet1").Range("QF10")
...
IE.Document.GetElementByID("tnthrE5AclR-O0qSiQtS832-val").Value = ThisWorkbook.Sheets("sheet1").Range("QG10")
...
IE.Document.GetElementByID("tnthrE5AclR-BdeLiKwXiCI-val").Value = ThisWorkbook.Sheets("sheet1").Range("QH10")
...
IE.Document.GetElementByID("tnthrE5AclR-fRexSBGA7FN-val").Value = ThisWorkbook.Sheets("sheet1").Range("QI10")
...
IE.Document.GetElementByID("tnthrE5AclR-p3xNmMndXrl-val").Value = ThisWorkbook.Sheets("sheet1").Range("QJ10")
...
IE.Document.GetElementByID("tnthrE5AclR-BZHzwUBVP7u-val").Value = ThisWorkbook.Sheets("sheet1").Range("QK10")
...
IE.Document.GetElementByID("tnthrE5AclR-dezDoHYzUWu-val").Value = ThisWorkbook.Sheets("sheet1").Range("QL10")
...
IE.Document.GetElementByID("tnthrE5AclR-W2jt0eaDKcD-val").Value = ThisWorkbook.Sheets("sheet1").Range("QM10")
...
IE.Document.GetElementByID("tnthrE5AclR-rGASCBRaR2U-val").Value = ThisWorkbook.Sheets("sheet1").Range("QN10")
...
IE.Document.GetElementByID("tnthrE5AclR-gWPhDYzmbw5-val").Value = ThisWorkbook.Sheets("sheet1").Range("QO10")
...
IE.Document.GetElementByID("tnthrE5AclR-LokBv4egnfg-val").Value = ThisWorkbook.Sheets("sheet1").Range("QP10")
...
IE.Document.GetElementByID("tnthrE5AclR-IsuCX2xSvKQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("QQ10")
...
IE.Document.GetElementByID("tnthrE5AclR-o3zyOwZyxi7-val").Value = ThisWorkbook.Sheets("sheet1").Range("QR10")
...
IE.Document.GetElementByID("tnthrE5AclR-hLjLWfjGWpK-val").Value = ThisWorkbook.Sheets("sheet1").Range("QS10")
...
IE.Document.GetElementByID("tnthrE5AclR-uPn8wdfqpnK-val").Value = ThisWorkbook.Sheets("sheet1").Range("QT10")
...
IE.Document.GetElementByID("tnthrE5AclR-T7F0DwyrbBV-val").Value = ThisWorkbook.Sheets("sheet1").Range("QU10")
...
IE.Document.GetElementByID("tnthrE5AclR-vUUk6jQrXdb-val").Value = ThisWorkbook.Sheets("sheet1").Range("QV10")
...
IE.Document.GetElementByID("tnthrE5AclR-wem5QqoRkkh-val").Value = ThisWorkbook.Sheets("sheet1").Range("QW10")
...
IE.Document.GetElementByID("tnthrE5AclR-VemdciGizc8-val").Value = ThisWorkbook.Sheets("sheet1").Range("QX10")
...
IE.Document.GetElementByID("tnthrE5AclR-V6ykris04Kr-val").Value = ThisWorkbook.Sheets("sheet1").Range("QY10")
...
IE.Document.GetElementByID("tnthrE5AclR-dywO69YrrUq-val").Value = ThisWorkbook.Sheets("sheet1").Range("QZ10")
...
IE.Document.GetElementByID("tnthrE5AclR-zDtqexNpaj8-val").Value = ThisWorkbook.Sheets("sheet1").Range("RA10")
...
IE.Document.GetElementByID("tnthrE5AclR-ClRyt3CO2CU-val").Value = ThisWorkbook.Sheets("sheet1").Range("RB10")
...
IE.Document.GetElementByID("tnthrE5AclR-ewxqtAm93uz-val").Value = ThisWorkbook.Sheets("sheet1").Range("RC10")
...
IE.Document.GetElementByID("tnthrE5AclR-rHymehDGb3n-val").Value = ThisWorkbook.Sheets("sheet1").Range("RD10")
...
IE.Document.GetElementByID("tnthrE5AclR-ew4H9zzs0GI-val").Value = ThisWorkbook.Sheets("sheet1").Range("RE10")
...
IE.Document.GetElementByID("tnthrE5AclR-eVb1NqOEUoq-val").Value = ThisWorkbook.Sheets("sheet1").Range("RF10")
...
IE.Document.GetElementByID("tnthrE5AclR-Ys91wCxDGwp-val").Value = ThisWorkbook.Sheets("sheet1").Range("RG10")
...
IE.Document.GetElementByID("tnthrE5AclR-Lq9WappoJ2W-val").Value = ThisWorkbook.Sheets("sheet1").Range("RH10")
...
IE.Document.GetElementByID("tnthrE5AclR-oBVan2Rcsdj-val").Value = ThisWorkbook.Sheets("sheet1").Range("RI10")
...
IE.Document.GetElementByID("tnthrE5AclR-zzHeHMx5Mh1-val").Value = ThisWorkbook.Sheets("sheet1").Range("RJ10")
...
IE.Document.GetElementByID("tnthrE5AclR-fpnwXTQGmD5-val").Value = ThisWorkbook.Sheets("sheet1").Range("RK10")
...
IE.Document.GetElementByID("tnthrE5AclR-hjgWcKahM96-val").Value = ThisWorkbook.Sheets("sheet1").Range("RL10")
...
IE.Document.GetElementByID("tnthrE5AclR-G6ksZzf4PuP-val").Value = ThisWorkbook.Sheets("sheet1").Range("RM10")
...
IE.Document.GetElementByID("tnthrE5AclR-mA6G2IcNQ5s-val").Value = ThisWorkbook.Sheets("sheet1").Range("RN10")
...
IE.Document.GetElementByID("tnthrE5AclR-zRdpU5xlOQI-val").Value = ThisWorkbook.Sheets("sheet1").Range("RO10")
...
IE.Document.GetElementByID("tnthrE5AclR-fu8H9OdUyZ6-val").Value = ThisWorkbook.Sheets("sheet1").Range("RP10")
...
IE.Document.GetElementByID("tnthrE5AclR-XqbMOMJhdoo-val").Value = ThisWorkbook.Sheets("sheet1").Range("RQ10")
...
IE.Document.GetElementByID("tnthrE5AclR-WUOsioCfTH1-val").Value = ThisWorkbook.Sheets("sheet1").Range("RR10")
...
IE.Document.GetElementByID("tnthrE5AclR-tNnfZGycqoK-val").Value = ThisWorkbook.Sheets("sheet1").Range("RS10")
...
IE.Document.GetElementByID("tnthrE5AclR-FsaFnYgYYiE-val").Value = ThisWorkbook.Sheets("sheet1").Range("RT10")
...
IE.Document.GetElementByID("tnthrE5AclR-HTuFkqNl46u-val").Value = ThisWorkbook.Sheets("sheet1").Range("RU10")
...
IE.Document.GetElementByID("tnthrE5AclR-EsEgz70ex5M-val").Value = ThisWorkbook.Sheets("sheet1").Range("RV10")
...
IE.Document.GetElementByID("tnthrE5AclR-XDgqQlbNOma-val").Value = ThisWorkbook.Sheets("sheet1").Range("RW10")
...
IE.Document.GetElementByID("tnthrE5AclR-GcAEOo6pgjG-val").Value = ThisWorkbook.Sheets("sheet1").Range("RX10")
...
IE.Document.GetElementByID("tnthrE5AclR-fN5EhNea5na-val").Value = ThisWorkbook.Sheets("sheet1").Range("RY10")
...
IE.Document.GetElementByID("tnthrE5AclR-O4M73r7CEs1-val").Value = ThisWorkbook.Sheets("sheet1").Range("RZ10")
...
IE.Document.GetElementByID("tnthrE5AclR-GJBPjJZBrRn-val").Value = ThisWorkbook.Sheets("sheet1").Range("SA10")
...
IE.Document.GetElementByID("tnthrE5AclR-JqROtRoCBHP-val").Value = ThisWorkbook.Sheets("sheet1").Range("SB10")
...
IE.Document.GetElementByID("tnthrE5AclR-GNrMxECWqDp-val").Value = ThisWorkbook.Sheets("sheet1").Range("SC10")
...
IE.Document.GetElementByID("tnthrE5AclR-aReRE4UUoKW-val").Value = ThisWorkbook.Sheets("sheet1").Range("SD10")
...
IE.Document.GetElementByID("tnthrE5AclR-XEIYBLvAzIb-val").Value = ThisWorkbook.Sheets("sheet1").Range("SE10")
...
IE.Document.GetElementByID("tnthrE5AclR-pVFmF7dKnTq-val").Value = ThisWorkbook.Sheets("sheet1").Range("SF10")
...
IE.Document.GetElementByID("tnthrE5AclR-pW32ZkMbRSO-val").Value = ThisWorkbook.Sheets("sheet1").Range("SG10")
...
IE.Document.GetElementByID("tnthrE5AclR-BiJwnz9vw41-val").Value = ThisWorkbook.Sheets("sheet1").Range("SH10")
...
IE.Document.GetElementByID("tnthrE5AclR-mN07ApGjAKh-val").Value = ThisWorkbook.Sheets("sheet1").Range("SI10")
...
IE.Document.GetElementByID("tnthrE5AclR-rL9fEh5MSHf-val").Value = ThisWorkbook.Sheets("sheet1").Range("SJ10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-azsFj6a0LS2-val").Value = ThisWorkbook.Sheets("sheet1").Range("SL10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-T6boOyU77Ow-val").Value = ThisWorkbook.Sheets("sheet1").Range("SM10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-QoyZ4jR8W84-val").Value = ThisWorkbook.Sheets("sheet1").Range("SN10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-t3gknDpzlB3-val").Value = ThisWorkbook.Sheets("sheet1").Range("SO10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-csHwh8Os7Ly-val").Value = ThisWorkbook.Sheets("sheet1").Range("SP10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-aoVZsO1PZWR-val").Value = ThisWorkbook.Sheets("sheet1").Range("SP10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-lf9E3w8D5Hf-val").Value = ThisWorkbook.Sheets("sheet1").Range("SR10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-xWKHVx9CSng-val").Value = ThisWorkbook.Sheets("sheet1").Range("SS10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-kF58z8fRC42-val").Value = ThisWorkbook.Sheets("sheet1").Range("ST10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-Mey121eVKzj-val").Value = ThisWorkbook.Sheets("sheet1").Range("SU10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-kbUM9XmC0Id-val").Value = ThisWorkbook.Sheets("sheet1").Range("SV10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-IuD1jatkIvP-val").Value = ThisWorkbook.Sheets("sheet1").Range("SW10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-xTYRwz7vBql-val").Value = ThisWorkbook.Sheets("sheet1").Range("SX10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-tbzlWEKQNNF-val").Value = ThisWorkbook.Sheets("sheet1").Range("SY10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-Z6fOXuimofv-val").Value = ThisWorkbook.Sheets("sheet1").Range("SZ10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-whrB9hVH3Lq-val").Value = ThisWorkbook.Sheets("sheet1").Range("TA10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-CD9WafYSd0R-val").Value = ThisWorkbook.Sheets("sheet1").Range("TB10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-lV8cuSvl3Hj-val").Value = ThisWorkbook.Sheets("sheet1").Range("TC10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-WHl3CaJheMm-val").Value = ThisWorkbook.Sheets("sheet1").Range("TD10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-SUIeS5MHsLm-val").Value = ThisWorkbook.Sheets("sheet1").Range("TE10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-NcQqIZNfkdp-val").Value = ThisWorkbook.Sheets("sheet1").Range("TF10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-tMJdJ24gicp-val").Value = ThisWorkbook.Sheets("sheet1").Range("TG10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-c0uiEFUIFvC-val").Value = ThisWorkbook.Sheets("sheet1").Range("TH10")
...
IE.Document.GetElementByID("uOfuBlHwdn7-BKmAjLKuCss-val").Value = ThisWorkbook.Sheets("sheet1").Range("TI10")
...
IE.Document.GetElementByID("QI0LrOAmBCG-jaxEUorPKgv-val").Value = ThisWorkbook.Sheets("sheet1").Range("TK10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-OMVFa98P0Yg-val").Value = ThisWorkbook.Sheets("sheet1").Range("TL10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-dRjezxQktoz-val").Value = ThisWorkbook.Sheets("sheet1").Range("TM10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-zLbjm4E1NsG-val").Value = ThisWorkbook.Sheets("sheet1").Range("TN10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-AG0milXShQM-val").Value = ThisWorkbook.Sheets("sheet1").Range("TO10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-QqlHrg6f0Sm-val").Value = ThisWorkbook.Sheets("sheet1").Range("TP10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-LyXZybq6Sjf-val").Value = ThisWorkbook.Sheets("sheet1").Range("TQ10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-zqARzn2wVj5-val").Value = ThisWorkbook.Sheets("sheet1").Range("TR10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-Vi8sd7mvZW4-val").Value = ThisWorkbook.Sheets("sheet1").Range("TS10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-hRq4baaUamW-val").Value = ThisWorkbook.Sheets("sheet1").Range("TT10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-PEXIFVXGP9S-val").Value = ThisWorkbook.Sheets("sheet1").Range("TU10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-J8fGj3Iefbc-val").Value = ThisWorkbook.Sheets("sheet1").Range("TV10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-lR2zeQ9VfB8-val").Value = ThisWorkbook.Sheets("sheet1").Range("TW10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-GnpJeq2XENE-val").Value = ThisWorkbook.Sheets("sheet1").Range("TX10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-jjUGfPF0ObP-val").Value = ThisWorkbook.Sheets("sheet1").Range("TY10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-p1HABZs9ydt-val").Value = ThisWorkbook.Sheets("sheet1").Range("TZ10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-tEMe0224zlP-val").Value = ThisWorkbook.Sheets("sheet1").Range("UA10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-LpnJL4zZxRH-val").Value = ThisWorkbook.Sheets("sheet1").Range("UB10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-NCnIv37EwU1-val").Value = ThisWorkbook.Sheets("sheet1").Range("UC10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-y9LP85d8t4b-val").Value = ThisWorkbook.Sheets("sheet1").Range("UD10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-YDzeLL6xf5o-val").Value = ThisWorkbook.Sheets("sheet1").Range("UE10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-XcW5HWccYYZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("UF10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-zouTxRQ0kXP-val").Value = ThisWorkbook.Sheets("sheet1").Range("UG10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-zUjkTTlva36-val").Value = ThisWorkbook.Sheets("sheet1").Range("UH10")
...
IE.Document.GetElementByID("yXZtvoYQXcD-QwUdNwRA8Uc-val").Value = ThisWorkbook.Sheets("sheet1").Range("UI10")
...
IE.Document.GetElementByID("NBLKn7nRBfo-wIv7t5fSIlK-val").Value = ThisWorkbook.Sheets("sheet1").Range("UJ10")
...
IE.Document.GetElementByID("NBLKn7nRBfo-R6XPf8j0tYt-val").Value = ThisWorkbook.Sheets("sheet1").Range("UK10")
...
IE.Document.GetElementByID("NBLKn7nRBfo-GhywTqKHQNM-val").Value = ThisWorkbook.Sheets("sheet1").Range("UL10")
...
IE.Document.GetElementByID("NBLKn7nRBfo-ZnMtvRMKMWh-val").Value = ThisWorkbook.Sheets("sheet1").Range("UM10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("UO10")) Then
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("VR10")) Then
'New on ART
'10-14
IE.Document.GetElementByID("iAYee99BIjX-kjmB7uKc99Z-val").Focus
IE.Document.GetElementByID("iAYee99BIjX-kjmB7uKc99Z-val").Value = ThisWorkbook.Sheets("sheet1").Range("VR10")
...
IE.Document.GetElementByID("iAYee99BIjX-Io640W5BM1N-val").Value = ThisWorkbook.Sheets("sheet1").Range("VS10")
...
IE.Document.GetElementByID("iAYee99BIjX-yBopqmUtvhv-val").Value = ThisWorkbook.Sheets("sheet1").Range("VT10")
...
IE.Document.GetElementByID("iAYee99BIjX-q8kWTLZlUdZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("VU10")
...
IE.Document.GetElementByID("iAYee99BIjX-sPByZmFYnZh-val").Value = ThisWorkbook.Sheets("sheet1").Range("VV10")
...
IE.Document.GetElementByID("iAYee99BIjX-rCrHJrYGJSl-val").Value = ThisWorkbook.Sheets("sheet1").Range("VW10")
...
IE.Document.GetElementByID("iAYee99BIjX-jz0vTkTNFGy-val").Value = ThisWorkbook.Sheets("sheet1").Range("VX10")
...
IE.Document.GetElementByID("iAYee99BIjX-dyREvvyOXaq-val").Value = ThisWorkbook.Sheets("sheet1").Range("VY10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("WA10")) Then
'Numerator
'Already on ART
'<1,F
IE.Document.GetElementByID("Qc1AaYpKsjs-Cq5xrLF7MiB-val").Focus
IE.Document.GetElementByID("Qc1AaYpKsjs-Cq5xrLF7MiB-val").Value = ThisWorkbook.Sheets("sheet1").Range("WA10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-E2lY8t3CmI5-val").Value = ThisWorkbook.Sheets("sheet1").Range("WB10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-F6uPBw7dmhp-val").Value = ThisWorkbook.Sheets("sheet1").Range("WC10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-rS9g7UL0rDN-val").Value = ThisWorkbook.Sheets("sheet1").Range("WD10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-ZufsQv0cYSM-val").Value = ThisWorkbook.Sheets("sheet1").Range("WE10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-r1p6hui37CP-val").Value = ThisWorkbook.Sheets("sheet1").Range("WF10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-kgvhGR4EKcK-val").Value = ThisWorkbook.Sheets("sheet1").Range("WG10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-GpSNvYc07tz-val").Value = ThisWorkbook.Sheets("sheet1").Range("WH10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-zq43uEufKnG-val").Value = ThisWorkbook.Sheets("sheet1").Range("WI10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-utzUqBePahs-val").Value = ThisWorkbook.Sheets("sheet1").Range("WJ10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-EJ5vQnO5114-val").Value = ThisWorkbook.Sheets("sheet1").Range("WK10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-Rmwyz2pyabR-val").Value = ThisWorkbook.Sheets("sheet1").Range("WL10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-QU5aTm14uA5-val").Value = ThisWorkbook.Sheets("sheet1").Range("WM10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-X49cjRccRAw-val").Value = ThisWorkbook.Sheets("sheet1").Range("WN10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-kb4QVVLaKnA-val").Value = ThisWorkbook.Sheets("sheet1").Range("WO10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-pjBfnMMU8yB-val").Value = ThisWorkbook.Sheets("sheet1").Range("WP10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-xp6h8T3cOfh-val").Value = ThisWorkbook.Sheets("sheet1").Range("WQ10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-kutUEi1Fp8G-val").Value = ThisWorkbook.Sheets("sheet1").Range("WR10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-gzztFm4KH6T-val").Value = ThisWorkbook.Sheets("sheet1").Range("WS10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-Kx0Ow7YSDv3-val").Value = ThisWorkbook.Sheets("sheet1").Range("WT10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-ZfvmeFeTV45-val").Value = ThisWorkbook.Sheets("sheet1").Range("WU10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-SFpj8nvfCkv-val").Value = ThisWorkbook.Sheets("sheet1").Range("WV10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-KSZqwBFQVqD-val").Value = ThisWorkbook.Sheets("sheet1").Range("WW10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-fWwSMmi37De-val").Value = ThisWorkbook.Sheets("sheet1").Range("WX10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-cW1wQgs5hyV-val").Value = ThisWorkbook.Sheets("sheet1").Range("WY10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-MQZqURahCb8-val").Value = ThisWorkbook.Sheets("sheet1").Range("WZ10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-JTZmQVEtlTV-val").Value = ThisWorkbook.Sheets("sheet1").Range("XA10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-ay15X6h55Py-val").Value = ThisWorkbook.Sheets("sheet1").Range("XB10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-AGQa2tzIoc1-val").Value = ThisWorkbook.Sheets("sheet1").Range("XC10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-suJrZbdKKRW-val").Value = ThisWorkbook.Sheets("sheet1").Range("XD10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-LlsXRvw2WCa-val").Value = ThisWorkbook.Sheets("sheet1").Range("XE10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-B3GuvVsPezs-val").Value = ThisWorkbook.Sheets("sheet1").Range("XF10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-VLZuKB5ZxAS-val").Value = ThisWorkbook.Sheets("sheet1").Range("XG10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-L94UC0mTPiS-val").Value = ThisWorkbook.Sheets("sheet1").Range("XH10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-FckvpCkm80Y-val").Value = ThisWorkbook.Sheets("sheet1").Range("XI10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-CTdgwVnmU4t-val").Value = ThisWorkbook.Sheets("sheet1").Range("XJ10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-PZfvIT6x87t-val").Value = ThisWorkbook.Sheets("sheet1").Range("XK10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-okUjaLgimz6-val").Value = ThisWorkbook.Sheets("sheet1").Range("XL10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-sNN69TORr55-val").Value = ThisWorkbook.Sheets("sheet1").Range("XM10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-PjCWWE6SRJc-val").Value = ThisWorkbook.Sheets("sheet1").Range("XN10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-NM0O8rpozsb-val").Value = ThisWorkbook.Sheets("sheet1").Range("XO10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-o7pTMaoJf1P-val").Value = ThisWorkbook.Sheets("sheet1").Range("XP10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-uK81Q5JSE2C-val").Value = ThisWorkbook.Sheets("sheet1").Range("XQ10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-E7IY48LF1ai-val").Value = ThisWorkbook.Sheets("sheet1").Range("XR10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-nMY8JaK7MKa-val").Value = ThisWorkbook.Sheets("sheet1").Range("XS10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-cPjx1nSG7kh-val").Value = ThisWorkbook.Sheets("sheet1").Range("XT10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-Kf4QAMTrtmg-val").Value = ThisWorkbook.Sheets("sheet1").Range("XU10")
...
IE.Document.GetElementByID("Qc1AaYpKsjs-GgZWK5MpPQ5-val").Value = ThisWorkbook.Sheets("sheet1").Range("XV10")
...
'Numerator
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("XX10")) Then
'Routine, Pregnant
IE.Document.GetElementByID("JTmqyoIWNsj-b1veZoOczoR-val").Focus
IE.Document.GetElementByID("JTmqyoIWNsj-b1veZoOczoR-val").Value = ThisWorkbook.Sheets("sheet1").Range("XX10")
...
IE.Document.GetElementByID("JTmqyoIWNsj-jBJaVu6svtP-val").Value = ThisWorkbook.Sheets("sheet1").Range("XY10")
...
IE.Document.GetElementByID("JTmqyoIWNsj-poFe6w8ZgCs-val").Value = ThisWorkbook.Sheets("sheet1").Range("XZ10")
...
IE.Document.GetElementByID("JTmqyoIWNsj-k78k8hp9kxN-val").Value = ThisWorkbook.Sheets("sheet1").Range("YA10")
...
IE.Document.GetElementByID("YvPOllVtINQ-YVmIiOo8V17-val").Value = ThisWorkbook.Sheets("sheet1").Range("YB10")
...
IE.Document.GetElementByID("YvPOllVtINQ-HDhg4LTHBRa-val").Value = ThisWorkbook.Sheets("sheet1").Range("YC10")
...
IE.Document.GetElementByID("YvPOllVtINQ-rAvlLbG5dAb-val").Value = ThisWorkbook.Sheets("sheet1").Range("YD10")
...
IE.Document.GetElementByID("YvPOllVtINQ-dpFsZrc6Ffc-val").Value = ThisWorkbook.Sheets("sheet1").Range("YE10")
...
IE.Document.GetElementByID("YvPOllVtINQ-A30fQSASmum-val").Value = ThisWorkbook.Sheets("sheet1").Range("YF10")
...
IE.Document.GetElementByID("YvPOllVtINQ-d7veFTMK1Jw-val").Value = ThisWorkbook.Sheets("sheet1").Range("YG10")
...
IE.Document.GetElementByID("YvPOllVtINQ-I0zEWK2C11q-val").Value = ThisWorkbook.Sheets("sheet1").Range("YH10")
...
IE.Document.GetElementByID("YvPOllVtINQ-RKp8rxNgQAX-val").Value = ThisWorkbook.Sheets("sheet1").Range("YI10")
...
IE.Document.GetElementByID("YvPOllVtINQ-MRnYv4nt5gc-val").Value = ThisWorkbook.Sheets("sheet1").Range("YJ10")
...
IE.Document.GetElementByID("YvPOllVtINQ-wOxLLZhNrPi-val").Value = ThisWorkbook.Sheets("sheet1").Range("YK10")
...
IE.Document.GetElementByID("YvPOllVtINQ-ONQ9uSvOkGB-val").Value = ThisWorkbook.Sheets("sheet1").Range("YL10")
...
IE.Document.GetElementByID("YvPOllVtINQ-U9R0CAPL0AS-val").Value = ThisWorkbook.Sheets("sheet1").Range("YM10")
...
IE.Document.GetElementByID("YvPOllVtINQ-vIZW4Jv7qqy-val").Value = ThisWorkbook.Sheets("sheet1").Range("YN10")
...
IE.Document.GetElementByID("YvPOllVtINQ-bQY52yJFcaj-val").Value = ThisWorkbook.Sheets("sheet1").Range("YO10")
...
IE.Document.GetElementByID("YvPOllVtINQ-sjBprG9Atqw-val").Value = ThisWorkbook.Sheets("sheet1").Range("YP10")
...
IE.Document.GetElementByID("YvPOllVtINQ-Cz8TfD9G4NS-val").Value = ThisWorkbook.Sheets("sheet1").Range("YQ10")
...
IE.Document.GetElementByID("YvPOllVtINQ-hX01YQ8Xd0A-val").Value = ThisWorkbook.Sheets("sheet1").Range("YR10")
...
IE.Document.GetElementByID("YvPOllVtINQ-Slv7vEZKRXb-val").Value = ThisWorkbook.Sheets("sheet1").Range("YS10")
...
IE.Document.GetElementByID("YvPOllVtINQ-X3iUwZMRbpC-val").Value = ThisWorkbook.Sheets("sheet1").Range("YT10")
...
IE.Document.GetElementByID("YvPOllVtINQ-ABHnQuSJzZJ-val").Value = ThisWorkbook.Sheets("sheet1").Range("YU10")
...
IE.Document.GetElementByID("YvPOllVtINQ-PRsdy4olkFE-val").Value = ThisWorkbook.Sheets("sheet1").Range("YV10")
...
IE.Document.GetElementByID("YvPOllVtINQ-TcbPwuDGR7C-val").Value = ThisWorkbook.Sheets("sheet1").Range("YW10")
...
IE.Document.GetElementByID("YvPOllVtINQ-Ba3F9Cdo4TM-val").Value = ThisWorkbook.Sheets("sheet1").Range("YX10")
...
IE.Document.GetElementByID("YvPOllVtINQ-hrDvHLgNfrf-val").Value = ThisWorkbook.Sheets("sheet1").Range("YY10")
...
IE.Document.GetElementByID("YvPOllVtINQ-KX9PVyZU0SC-val").Value = ThisWorkbook.Sheets("sheet1").Range("YZ10")
...
IE.Document.GetElementByID("YvPOllVtINQ-L1ObFoxjva6-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZA10")
...
IE.Document.GetElementByID("YvPOllVtINQ-MEmyd94Q6WV-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZB10")
...
IE.Document.GetElementByID("YvPOllVtINQ-XdPalqXCZoU-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZC10")
...
IE.Document.GetElementByID("YvPOllVtINQ-bF0weSMLcXP-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZD10")
...
IE.Document.GetElementByID("YvPOllVtINQ-RtATUnvscNN-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZE10")
...
IE.Document.GetElementByID("YvPOllVtINQ-sIQwZRXuYwt-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZF10")
...
IE.Document.GetElementByID("YvPOllVtINQ-LhEFchQfNOo-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZG10")
...
IE.Document.GetElementByID("YvPOllVtINQ-VwiNQ9ZBi6N-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZH10")
...
IE.Document.GetElementByID("YvPOllVtINQ-ZbXKfTyFNc2-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZI10")
...
IE.Document.GetElementByID("YvPOllVtINQ-E9mZCkjKTrk-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZJ10")
...
IE.Document.GetElementByID("YvPOllVtINQ-Mmj6PfG0MD2-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZK10")
...
IE.Document.GetElementByID("YvPOllVtINQ-j9nkZnYOQ2j-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZL10")
...
IE.Document.GetElementByID("YvPOllVtINQ-ugfxT6Y9fVT-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZM10")
...
IE.Document.GetElementByID("YvPOllVtINQ-GTyaeyYttO7-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZN10")
...
IE.Document.GetElementByID("YvPOllVtINQ-GsqfEv7ONZC-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZO10")
...
IE.Document.GetElementByID("YvPOllVtINQ-PrDW5lYkfid-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZP10")
...
IE.Document.GetElementByID("YvPOllVtINQ-k5zqWba6iGZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZQ10")
...
IE.Document.GetElementByID("YvPOllVtINQ-g8GIFx03IlN-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZR10")
...
IE.Document.GetElementByID("YvPOllVtINQ-BoVxsZvmVD3-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZS10")
...
IE.Document.GetElementByID("YvPOllVtINQ-ooErPHdkcUi-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZT10")
...
IE.Document.GetElementByID("YvPOllVtINQ-lIjZjuzUGWd-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZU10")
...
IE.Document.GetElementByID("YvPOllVtINQ-bYjNYUiHRzF-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZV10")
...
IE.Document.GetElementByID("YvPOllVtINQ-E4AmAvdxkJA-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZW10")
IE.Document.GetElementByID("YvPOllVtINQ-E4AmAvdxkJA-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))
End If
'Denominator
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ZY10")) Then
'Routine, Pregnant
IE.Document.GetElementByID("eQdclZl2AoR-b1veZoOczoR-val").Focus
IE.Document.GetElementByID("eQdclZl2AoR-b1veZoOczoR-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZY10")
...
IE.Document.GetElementByID("eQdclZl2AoR-jBJaVu6svtP-val").Value = ThisWorkbook.Sheets("sheet1").Range("ZZ10")
...
IE.Document.GetElementByID("eQdclZl2AoR-poFe6w8ZgCs-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAA10")
...
IE.Document.GetElementByID("eQdclZl2AoR-k78k8hp9kxN-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAB10")
...
IE.Document.GetElementByID("kznQBykTtJt-YVmIiOo8V17-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAC10")
...
IE.Document.GetElementByID("kznQBykTtJt-HDhg4LTHBRa-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAD10")
...
IE.Document.GetElementByID("kznQBykTtJt-rAvlLbG5dAb-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAE10")
...
IE.Document.GetElementByID("kznQBykTtJt-dpFsZrc6Ffc-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAF10")
...
IE.Document.GetElementByID("kznQBykTtJt-A30fQSASmum-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAG10")
...
IE.Document.GetElementByID("kznQBykTtJt-d7veFTMK1Jw-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAH10")
...
IE.Document.GetElementByID("kznQBykTtJt-I0zEWK2C11q-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAI10")
...
IE.Document.GetElementByID("kznQBykTtJt-RKp8rxNgQAX-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAJ10")
...
IE.Document.GetElementByID("kznQBykTtJt-MRnYv4nt5gc-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAK10")
...
IE.Document.GetElementByID("kznQBykTtJt-wOxLLZhNrPi-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAL10")
...
IE.Document.GetElementByID("kznQBykTtJt-ONQ9uSvOkGB-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAM10")
...
IE.Document.GetElementByID("kznQBykTtJt-U9R0CAPL0AS-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAN10")
...
IE.Document.GetElementByID("kznQBykTtJt-vIZW4Jv7qqy-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAO10")
...
IE.Document.GetElementByID("kznQBykTtJt-bQY52yJFcaj-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAP10")
...
IE.Document.GetElementByID("kznQBykTtJt-sjBprG9Atqw-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAQ10")
...
IE.Document.GetElementByID("kznQBykTtJt-Cz8TfD9G4NS-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAR10")
...
IE.Document.GetElementByID("kznQBykTtJt-hX01YQ8Xd0A-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAS10")
...
IE.Document.GetElementByID("kznQBykTtJt-Slv7vEZKRXb-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAT10")
...
IE.Document.GetElementByID("kznQBykTtJt-X3iUwZMRbpC-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAU10")
...
IE.Document.GetElementByID("kznQBykTtJt-ABHnQuSJzZJ-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAV10")
...
IE.Document.GetElementByID("kznQBykTtJt-PRsdy4olkFE-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAW10")
...
IE.Document.GetElementByID("kznQBykTtJt-TcbPwuDGR7C-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAX10")
...
IE.Document.GetElementByID("kznQBykTtJt-Ba3F9Cdo4TM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAY10")
...
IE.Document.GetElementByID("kznQBykTtJt-hrDvHLgNfrf-val").Value = ThisWorkbook.Sheets("sheet1").Range("AAZ10")
...
IE.Document.GetElementByID("kznQBykTtJt-KX9PVyZU0SC-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABA10")
...
IE.Document.GetElementByID("kznQBykTtJt-L1ObFoxjva6-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABB10")
...
IE.Document.GetElementByID("kznQBykTtJt-MEmyd94Q6WV-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABC10")
...
IE.Document.GetElementByID("kznQBykTtJt-XdPalqXCZoU-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABD10")
...
IE.Document.GetElementByID("kznQBykTtJt-bF0weSMLcXP-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABE10")
...
IE.Document.GetElementByID("kznQBykTtJt-RtATUnvscNN-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABF10")
...
IE.Document.GetElementByID("kznQBykTtJt-sIQwZRXuYwt-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABG10")
...
IE.Document.GetElementByID("kznQBykTtJt-LhEFchQfNOo-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABH10")
...
IE.Document.GetElementByID("kznQBykTtJt-VwiNQ9ZBi6N-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABI10")
...
IE.Document.GetElementByID("kznQBykTtJt-ZbXKfTyFNc2-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABJ10")
...
IE.Document.GetElementByID("kznQBykTtJt-E9mZCkjKTrk-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABK10")
...
IE.Document.GetElementByID("kznQBykTtJt-Mmj6PfG0MD2-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABL10")
...
IE.Document.GetElementByID("kznQBykTtJt-j9nkZnYOQ2j-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABM10")
...
IE.Document.GetElementByID("kznQBykTtJt-ugfxT6Y9fVT-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABN10")
...
IE.Document.GetElementByID("kznQBykTtJt-GTyaeyYttO7-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABO10")
...
IE.Document.GetElementByID("kznQBykTtJt-GsqfEv7ONZC-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABP10")
...
IE.Document.GetElementByID("kznQBykTtJt-PrDW5lYkfid-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABQ10")
...
IE.Document.GetElementByID("kznQBykTtJt-k5zqWba6iGZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABR10")
...
IE.Document.GetElementByID("kznQBykTtJt-g8GIFx03IlN-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABS10")
...
IE.Document.GetElementByID("kznQBykTtJt-BoVxsZvmVD3-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABT10")
...
IE.Document.GetElementByID("kznQBykTtJt-ooErPHdkcUi-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABU10")
...
IE.Document.GetElementByID("kznQBykTtJt-lIjZjuzUGWd-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABV10")
...
IE.Document.GetElementByID("kznQBykTtJt-bYjNYUiHRzF-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABW10")
...
IE.Document.GetElementByID("kznQBykTtJt-E4AmAvdxkJA-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABX10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ABZ10")) Then
'15-19,F
IE.Document.GetElementByID("KNO4emPfF91-BYmlmGMcCWx-val").Focus
IE.Document.GetElementByID("KNO4emPfF91-BYmlmGMcCWx-val").Value = ThisWorkbook.Sheets("sheet1").Range("ABZ10")
...
IE.Document.GetElementByID("KNO4emPfF91-zE5NFpGXDy4-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACA10")
...
IE.Document.GetElementByID("KNO4emPfF91-u88hOHhmLuF-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACB10")
...
IE.Document.GetElementByID("KNO4emPfF91-tcJ9vZbCWcO-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACC10")
...
IE.Document.GetElementByID("KNO4emPfF91-WghEsgfAUAb-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACD10")
...
IE.Document.GetElementByID("KNO4emPfF91-Ij7k6DBjI3i-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACE10")
...
IE.Document.GetElementByID("KNO4emPfF91-dIfXCJxd5bY-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACF10")
...
IE.Document.GetElementByID("KNO4emPfF91-xqiQnxlVCYm-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACG10")
...
IE.Document.GetElementByID("KNO4emPfF91-kQ58FETBxFn-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACH10")
...
IE.Document.GetElementByID("KNO4emPfF91-jJifRzf2Z8j-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACI10")
...
IE.Document.GetElementByID("KNO4emPfF91-necuVZOR1HB-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACJ10")
...
IE.Document.GetElementByID("KNO4emPfF91-HnDmWypXRdG-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACK10")
...
IE.Document.GetElementByID("KNO4emPfF91-Sq9vathzQd9-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACL10")
...
IE.Document.GetElementByID("KNO4emPfF91-f6m1joVHJgj-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACM10")
...
IE.Document.GetElementByID("KNO4emPfF91-efXnrOzWCGW-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACN10")
...
IE.Document.GetElementByID("KNO4emPfF91-fSgFPhUpbWq-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACO10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ACQ10")) Then
'15-19,F
IE.Document.GetElementByID("x5H3nrR8BNW-BYmlmGMcCWx-val").Focus
IE.Document.GetElementByID("x5H3nrR8BNW-BYmlmGMcCWx-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACQ10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-zE5NFpGXDy4-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACR10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-u88hOHhmLuF-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACS10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-tcJ9vZbCWcO-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACT10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-WghEsgfAUAb-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACU10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-Ij7k6DBjI3i-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACV0")
...
IE.Document.GetElementByID("x5H3nrR8BNW-dIfXCJxd5bY-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACW10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-xqiQnxlVCYm-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACX10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-kQ58FETBxFn-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACY10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-jJifRzf2Z8j-val").Value = ThisWorkbook.Sheets("sheet1").Range("ACZ10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-necuVZOR1HB-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADA10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-HnDmWypXRdG-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADB10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-Sq9vathzQd9-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADCX10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-f6m1joVHJgj-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADD10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-efXnrOzWCGW-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADE10")
...
IE.Document.GetElementByID("x5H3nrR8BNW-fSgFPhUpbWq-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADF10")
...
IE.Document.GetElementByID("YJ29Pdq78W9-KZLKkTI9JDW-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADG10")
...
IE.Document.GetElementByID("YJ29Pdq78W9-wk0iX1oD0k8-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADH10")
...
IE.Document.GetElementByID("YJ29Pdq78W9-IYCY7by7MB6-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADI10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ADK10")) Then
'Numerator
'IPT, Newly, <15, F
IE.Document.GetElementByID("snsnfDStk7C-mi7E9CADWSN-val").Focus
IE.Document.GetElementByID("snsnfDStk7C-mi7E9CADWSN-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADK10")
...
IE.Document.GetElementByID("snsnfDStk7C-JR95o8Xtizl-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADL10")
...
IE.Document.GetElementByID("snsnfDStk7C-wf5dnqcNzsC-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADM10")
...
IE.Document.GetElementByID("snsnfDStk7C-DYWHCdJGVCo-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADN10")
...
IE.Document.GetElementByID("snsnfDStk7C-EtjoXVvdmke-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADO10")
...
IE.Document.GetElementByID("snsnfDStk7C-M4jO9QCDbGa-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADP10")
...
IE.Document.GetElementByID("snsnfDStk7C-H7mVNYfFpZK-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADQ10")
...
IE.Document.GetElementByID("snsnfDStk7C-UhCTzS8qdWx-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADR10")
IE.Document.GetElementByID("snsnfDStk7C-UhCTzS8qdWx-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))
End If
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AEB10")) Then
'Denominator
'IPT, Newly, <15, F
IE.Document.GetElementByID("KTrXeuvf4iQ-mi7E9CADWSN-val").Focus
IE.Document.GetElementByID("KTrXeuvf4iQ-mi7E9CADWSN-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEB10")
...
IE.Document.GetElementByID("KTrXeuvf4iQ-JR95o8Xtizl-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEC10")
...
IE.Document.GetElementByID("KTrXeuvf4iQ-wf5dnqcNzsC-val").Value = ThisWorkbook.Sheets("sheet1").Range("AED10")
...
IE.Document.GetElementByID("KTrXeuvf4iQ-DYWHCdJGVCo-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEE10")
...
IE.Document.GetElementByID("KTrXeuvf4iQ-EtjoXVvdmke-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEF10")
...
IE.Document.GetElementByID("KTrXeuvf4iQ-M4jO9QCDbGa-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEG10")
...
IE.Document.GetElementByID("KTrXeuvf4iQ-H7mVNYfFpZK-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEH10")
...
IE.Document.GetElementByID("KTrXeuvf4iQ-UhCTzS8qdWx-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEI10")
...
evt.initEvent "change", True, False
Application.Wait Now + TimeValue("00:00:03")
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AES10")) Then
'Negative
'15-19
IE.Document.GetElementByID("XboLlTkc4Av-dh4TQ68p2SC-val").Focus
IE.Document.GetElementByID("XboLlTkc4Av-dh4TQ68p2SC-val").Value = ThisWorkbook.Sheets("sheet1").Range("AES10")
...
IE.Document.GetElementByID("XboLlTkc4Av-pdCeAB4EYYM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AET10")
...
IE.Document.GetElementByID("XboLlTkc4Av-qgGxi9db8sQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEU10")
...
IE.Document.GetElementByID("XboLlTkc4Av-ZLqwxAM0rDn-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEV10")
...
IE.Document.GetElementByID("XboLlTkc4Av-k6PpW7YsDek-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEW10")
...
IE.Document.GetElementByID("XboLlTkc4Av-Rs8GH9wo2Iq-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEX10")
...
IE.Document.GetElementByID("XboLlTkc4Av-dyxvzwmNPGZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEY10")
...
IE.Document.GetElementByID("XboLlTkc4Av-dr2VUvtgDGn-val").Value = ThisWorkbook.Sheets("sheet1").Range("AEZ10")
...
IE.Document.GetElementByID("XboLlTkc4Av-fJ4uotAMsvK-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFA10")
...
IE.Document.GetElementByID("XboLlTkc4Av-HMzo64LcweA-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFB10")
...
IE.Document.GetElementByID("XboLlTkc4Av-vW2cAkyRE1o-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFC10")
...
IE.Document.GetElementByID("XboLlTkc4Av-O7xahbUykIN-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFD10")
...
IE.Document.GetElementByID("XboLlTkc4Av-t30vaBv4cPu-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFE10")
...
IE.Document.GetElementByID("XboLlTkc4Av-lGLhiwNxWOk-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFF10")
...
IE.Document.GetElementByID("XboLlTkc4Av-TSVq2SiVSqr-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFG10")
...
IE.Document.GetElementByID("XboLlTkc4Av-SXr2dJIXau2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFH10")
...
IE.Document.GetElementByID("XboLlTkc4Av-nI9rG3vPWQz-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFI10")
...
IE.Document.GetElementByID("XboLlTkc4Av-bUHsLsQL80m-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFJ10")
...
IE.Document.GetElementByID("XboLlTkc4Av-sngMFN7RcpA-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFK10")
...
IE.Document.GetElementByID("XboLlTkc4Av-nFHijHYOiFf-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFL10")
...
IE.Document.GetElementByID("XboLlTkc4Av-E37hIruafwo-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFM10")
...
IE.Document.GetElementByID("XboLlTkc4Av-bbH8Y4ejXSr-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFN10")
...
IE.Document.GetElementByID("XboLlTkc4Av-B5fJ4gs57Jz-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFO10")
...
IE.Document.GetElementByID("XboLlTkc4Av-GGSHmwiOMQX-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFP10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AFR10")) Then
'<1,F,Died
IE.Document.GetElementByID("DRRao8jDO3b-HCBbyzN9hg8-val").Focus
IE.Document.GetElementByID("DRRao8jDO3b-HCBbyzN9hg8-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFR10")
...
IE.Document.GetElementByID("DRRao8jDO3b-DuKFTCDTm36-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFS10")
...
IE.Document.GetElementByID("DRRao8jDO3b-UbzJ7tg5zo2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFT10")
...
IE.Document.GetElementByID("DRRao8jDO3b-zh9NgGkXtF8-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFU10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Hs4V3lH4yQU-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFV10")
...
IE.Document.GetElementByID("DRRao8jDO3b-UmxJVH7qDiF-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFW10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Equr4VbOl5H-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFX10")
...
IE.Document.GetElementByID("DRRao8jDO3b-LInafos6gzb-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFY10")
...
IE.Document.GetElementByID("DRRao8jDO3b-C87iWhgzBDu-val").Value = ThisWorkbook.Sheets("sheet1").Range("AFZ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-JQEU6nKw7gb-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGA10")
...
IE.Document.GetElementByID("DRRao8jDO3b-P0NgrRvn84T-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGB10")
...
IE.Document.GetElementByID("DRRao8jDO3b-yybElZFCO86-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGC10")
...
IE.Document.GetElementByID("DRRao8jDO3b-jWiak0ltNja-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGD10")
...
IE.Document.GetElementByID("DRRao8jDO3b-e8nZ8Rb8EMt-val").Value = ThisWorkbook.Sheets("sheet1").Range("ADE10")
...
IE.Document.GetElementByID("DRRao8jDO3b-xVjQHjVzAU0-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGF10")
...
IE.Document.GetElementByID("DRRao8jDO3b-mjJM5dG14VO-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGG10")
...
IE.Document.GetElementByID("DRRao8jDO3b-E8qNYIDZfnQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGH10")
...
IE.Document.GetElementByID("DRRao8jDO3b-WMOWrnR0Tk6-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGI10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Ftq9p9Xzahl-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGJ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-QKoLnrKVGpz-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGK10")
...
IE.Document.GetElementByID("DRRao8jDO3b-fNEJdk6Vl8e-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGL10")
...
IE.Document.GetElementByID("DRRao8jDO3b-GnyPqshMifv-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGM10")
...
IE.Document.GetElementByID("DRRao8jDO3b-P7KWqQDn7W5-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGN10")
...
IE.Document.GetElementByID("DRRao8jDO3b-oBEwjtWfAr1-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGO10")
IE.Document.GetElementByID("DRRao8jDO3b-oBEwjtWfAr1-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))
End If

If WorksheetFunction.Sum(ThisWorkbook.Sheets("sheet1").Range("AGP10:AHM10")) > 0 Then
'<1,F,Undocumented
IE.Document.GetElementByID("DRRao8jDO3b-jcGn34hM7CM-val").Focus
IE.Document.GetElementByID("DRRao8jDO3b-jcGn34hM7CM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGP10")
...
IE.Document.GetElementByID("DRRao8jDO3b-snzivZEJGbS-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGQ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-lAeUhj40On2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGR10")
...
IE.Document.GetElementByID("DRRao8jDO3b-M9K61pkTRQ7-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGS10")
...
IE.Document.GetElementByID("DRRao8jDO3b-xquAaKS2vus-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGT10")
...
IE.Document.GetElementByID("DRRao8jDO3b-nT8jUXqnSZb-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGU10")
...
IE.Document.GetElementByID("DRRao8jDO3b-v2PeaF7bkNQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGV10")
...
IE.Document.GetElementByID("DRRao8jDO3b-bSYbnekjG80-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGW10")
...
IE.Document.GetElementByID("DRRao8jDO3b-FDfLnvQHv36-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGX10")
...
IE.Document.GetElementByID("DRRao8jDO3b-sSCq0rQzP3N-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGY10")
...
IE.Document.GetElementByID("DRRao8jDO3b-GSreeLJQ9zl-val").Value = ThisWorkbook.Sheets("sheet1").Range("AGZ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Wmb3xexdwAm-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHA10")
...
IE.Document.GetElementByID("DRRao8jDO3b-w2CW3477MZM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHB10")
...
IE.Document.GetElementByID("DRRao8jDO3b-jxzbYhmX5nG-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHC10")
...
IE.Document.GetElementByID("DRRao8jDO3b-TcEjofQpSBV-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHD10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Fqe0m1jYRXf-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHE10")
...
IE.Document.GetElementByID("DRRao8jDO3b-QuXcOl4tIsf-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHF10")
...
IE.Document.GetElementByID("DRRao8jDO3b-hUSzr4Oih8g-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHG10")
...
IE.Document.GetElementByID("DRRao8jDO3b-MfGPeF35m97-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHH10")
...
IE.Document.GetElementByID("DRRao8jDO3b-y3dBv0HtQYZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHI10")
...
IE.Document.GetElementByID("DRRao8jDO3b-ZDG6xrz1vws-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHJ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-IKqHtXAF5M4-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHK10")
...
IE.Document.GetElementByID("DRRao8jDO3b-T3KexHFBsiY-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHL10")
...
IE.Document.GetElementByID("DRRao8jDO3b-L10xZJdRTfn-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHM10")
IE.Document.GetElementByID("DRRao8jDO3b-L10xZJdRTfn-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int ((5 - 2 + 1) * Rnd + 2))
End If

If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AHN10")) Then
'<1,F,Traced
IE.Document.GetElementByID("DRRao8jDO3b-HV1wVebGpMx-val").Focus
IE.Document.GetElementByID("DRRao8jDO3b-HV1wVebGpMx-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHN10")
...
IE.Document.GetElementByID("DRRao8jDO3b-ZaX7T1mm60R-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHO10")
...
IE.Document.GetElementByID("DRRao8jDO3b-VMun3Ah6e2k-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHP10")
...
IE.Document.GetElementByID("DRRao8jDO3b-LllUyIWhS95-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHQ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-EUfl8e8BFwN-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHR10")
...
IE.Document.GetElementByID("DRRao8jDO3b-yGoN7frP7i8-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHS10")
...
IE.Document.GetElementByID("DRRao8jDO3b-ku6Q0SHxw6c-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHT10")
...
IE.Document.GetElementByID("DRRao8jDO3b-uKQCp8AOQUL-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHU10")
...
IE.Document.GetElementByID("DRRao8jDO3b-l1DgaTNLde2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHV10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Qw8gl4XnlCl-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHW10")
...
IE.Document.GetElementByID("DRRao8jDO3b-We6rTd6cmTn-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHX10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Sf78ll04lov-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHY10")
...
IE.Document.GetElementByID("DRRao8jDO3b-ZRAcFMpcVKE-val").Value = ThisWorkbook.Sheets("sheet1").Range("AHZ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-gDy1YoIcG47-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIA10")
...
IE.Document.GetElementByID("DRRao8jDO3b-rHMVe4mVaaF-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIB10")
...
IE.Document.GetElementByID("DRRao8jDO3b-QDMMRyv1b7C-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIC10")
...
IE.Document.GetElementByID("DRRao8jDO3b-MnuYBsHKprM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AID10")
...
IE.Document.GetElementByID("DRRao8jDO3b-e5VaP9zoRlF-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIE10")
...
IE.Document.GetElementByID("DRRao8jDO3b-d7q0I4AnH38-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIF10")
...
IE.Document.GetElementByID("DRRao8jDO3b-iCf9JjKSCs9-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIG10")
...
IE.Document.GetElementByID("DRRao8jDO3b-sZC9E3g2YMR-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIH10")
...
IE.Document.GetElementByID("DRRao8jDO3b-DkxCY8ooSbT-val").Value = ThisWorkbook.Sheets("sheet1").Range("AII10")
...
IE.Document.GetElementByID("DRRao8jDO3b-B9qdd7xhhV8-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIJ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-GNsVNj0Ixaf-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIK10")
IE.Document.GetElementByID("DRRao8jDO3b-GNsVNj0Ixaf-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))
End If

If WorksheetFunction.Sum(ThisWorkbook.Sheets("sheet1").Range("AIL10:AJI10")) > 0 Then
'<1,F,Not Traced
IE.Document.GetElementByID("DRRao8jDO3b-WaZ44hZGwnz-val").Focus
IE.Document.GetElementByID("DRRao8jDO3b-WaZ44hZGwnz-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIL10")
...
IE.Document.GetElementByID("DRRao8jDO3b-GXFo4k45eAM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIM10")
...
IE.Document.GetElementByID("DRRao8jDO3b-vKg75GjS5QU-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIN10")
...
IE.Document.GetElementByID("DRRao8jDO3b-dZwhp1lGH3p-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIO10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Q8IE6eZFU6b-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIP10")
...
IE.Document.GetElementByID("DRRao8jDO3b-sFYVPJeZeF8-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIQ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-EOlZOp0zPC8-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIR10")
...
IE.Document.GetElementByID("DRRao8jDO3b-dN1vezY5hMc-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIS10")
...
IE.Document.GetElementByID("DRRao8jDO3b-FrXeF1L4Cai-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIT10")
...
IE.Document.GetElementByID("DRRao8jDO3b-I3s48dA0POC-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIU10")
...
IE.Document.GetElementByID("DRRao8jDO3b-DRuqLDykEsD-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIV10")
...
IE.Document.GetElementByID("DRRao8jDO3b-O5R93yZV2vI-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIW10")
...
IE.Document.GetElementByID("DRRao8jDO3b-O5eSRv5ilPX-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIX10")
...
IE.Document.GetElementByID("DRRao8jDO3b-s7cVR8kuw6O-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIY10")
...
IE.Document.GetElementByID("DRRao8jDO3b-lYZr3YQFhJT-val").Value = ThisWorkbook.Sheets("sheet1").Range("AIZ10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Pl43wEY2mzc-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJA10")
...
IE.Document.GetElementByID("DRRao8jDO3b-fiPPb7yWErg-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJB10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Ruc2yLIdJ9j-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJC10")
...
IE.Document.GetElementByID("DRRao8jDO3b-KMZYnlijkNP-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJD10")
...
IE.Document.GetElementByID("DRRao8jDO3b-Dd09elTPhgB-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJE10")
...
IE.Document.GetElementByID("DRRao8jDO3b-qIUoao32x7G-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJF10")
...
IE.Document.GetElementByID("DRRao8jDO3b-BqaHdvdIGjY-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJG10")
...
IE.Document.GetElementByID("DRRao8jDO3b-ZgKfWGQK5xR-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJH10")
...
IE.Document.GetElementByID("DRRao8jDO3b-RSNoAYua8oo-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJI10")
...
Set evt = IE.Document.createEvent("HTMLEvents")
evt.initEvent "change", True, False
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AJK10")) Then
'Numerator
'New,F,<15
IE.Document.GetElementByID("DHhB2W8z4k6-ptrqjblDpVl-val").Focus
IE.Document.GetElementByID("DHhB2W8z4k6-ptrqjblDpVl-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJK10")
...
IE.Document.GetElementByID("DHhB2W8z4k6-hcF36Hpaxmu-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJL10")
...
IE.Document.GetElementByID("DHhB2W8z4k6-EP6ShhD5ntH-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJM10")
...
IE.Document.GetElementByID("DHhB2W8z4k6-b2lYKJk1pWg-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJN10")
...
IE.Document.GetElementByID("DHhB2W8z4k6-ujjzYH3AbhZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJO10")
...
IE.Document.GetElementByID("DHhB2W8z4k6-IKLIV8BEfT2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJP10")
...
IE.Document.GetElementByID("DHhB2W8z4k6-Cqb6VN74EwO-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJQ10")
...
IE.Document.GetElementByID("DHhB2W8z4k6-TWPXb0rvc3p-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJR10")
IE.Document.GetElementByID("DHhB2W8z4k6-TWPXb0rvc3p-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))
End If
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AJT10")) Then
'Denominator
'SP, Newly, <15, F
IE.Document.GetElementByID("YVqdD78gGE1-qEv2Oi1bHsp-val").Focus
IE.Document.GetElementByID("YVqdD78gGE1-qEv2Oi1bHsp-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJT10")
...
IE.Document.GetElementByID("YVqdD78gGE1-BpjQgbuhZoo-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJU10")
...
IE.Document.GetElementByID("YVqdD78gGE1-zpOXupkpl7i-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJV10")
...
IE.Document.GetElementByID("YVqdD78gGE1-Y9GhVNf8jUd-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJW10")
...
IE.Document.GetElementByID("YVqdD78gGE1-qBj9XLbUigZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJY10")
...
IE.Document.GetElementByID("YVqdD78gGE1-vsVKGzHxDua-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJX10")
...
IE.Document.GetElementByID("YVqdD78gGE1-VyeN2c8Zdi4-val").Value = ThisWorkbook.Sheets("sheet1").Range("AJZ10")
...
IE.Document.GetElementByID("YVqdD78gGE1-SZ3D287on4h-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKA10")
...
IE.Document.GetElementByID("YVqdD78gGE1-KcI8l7j9oeX-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKB10")
...
IE.Document.GetElementByID("YVqdD78gGE1-kCzjNAGH5GY-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKC10")
...
IE.Document.GetElementByID("YVqdD78gGE1-JURc3Uxzcr9-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKD10")
...
IE.Document.GetElementByID("YVqdD78gGE1-rktDV3ZuQjl-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKE10")
...
IE.Document.GetElementByID("YVqdD78gGE1-yxdKq1ZC8fS-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKF10")
...
IE.Document.GetElementByID("YVqdD78gGE1-DFLZuSpRYKv-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKG10")
...
IE.Document.GetElementByID("YVqdD78gGE1-NrvW7I8iYbo-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKH10")
...
IE.Document.GetElementByID("YVqdD78gGE1-u53iyNLwf4u-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKI10")
...
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AKP10")) Then
'Cervical Cancer screen: Cryotherapy
'15-19
IE.Document.GetElementByID("D8gXql7mhrZ-Njt3hvrCNIO-val").Focus
IE.Document.GetElementByID("D8gXql7mhrZ-Njt3hvrCNIO-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKP10")
...
IE.Document.GetElementByID("D8gXql7mhrZ-ycC6TYD1fK8-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKQ10")
...
IE.Document.GetElementByID("D8gXql7mhrZ-esEoT2zyIAD-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKR10")
...
IE.Document.GetElementByID("D8gXql7mhrZ-RMeYVgQI1xD-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKS10")
...
IE.Document.GetElementByID("D8gXql7mhrZ-yUZniFjLR4K-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKT10")
...
IE.Document.GetElementByID("D8gXql7mhrZ-ca7gG3WIozw-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKU10")
...
IE.Document.GetElementByID("D8gXql7mhrZ-wk3ttV4GTnT-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKV10")
...
IE.Document.GetElementByID("D8gXql7mhrZ-iV3JZe1JRsk-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKW10")
...
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("AKY10")) Then
'Sexual Violence
'Female,<10
IE.Document.GetElementByID("GT81rJIJrrd-zq6hDM0eyHD-val").Focus
IE.Document.GetElementByID("GT81rJIJrrd-zq6hDM0eyHD-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKY10")
...
IE.Document.GetElementByID("GT81rJIJrrd-SgTYo6S71cR-val").Value = ThisWorkbook.Sheets("sheet1").Range("AKZ10")
...
IE.Document.GetElementByID("GT81rJIJrrd-aUwnyHuwMoM-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALA10")
...
IE.Document.GetElementByID("GT81rJIJrrd-zcgpWAmwXDe-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALB10")
...
IE.Document.GetElementByID("GT81rJIJrrd-IO9GD263u2H-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALC10")
...
IE.Document.GetElementByID("GT81rJIJrrd-qFe4iOwYox4-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALD10")
...
IE.Document.GetElementByID("GT81rJIJrrd-ewXoNYCdpYZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALE10")
...
IE.Document.GetElementByID("GT81rJIJrrd-xaE1rwbDcrA-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALF10")
...
IE.Document.GetElementByID("GT81rJIJrrd-f5UCCdzK3Tv-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALG10")
...
IE.Document.GetElementByID("GT81rJIJrrd-zu9HrgDHyQT-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALH10")
...
IE.Document.GetElementByID("GT81rJIJrrd-EjDC8XG5FTV-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALI10")
...
IE.Document.GetElementByID("GT81rJIJrrd-rMROM7S9IcM-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALJ10")
...
IE.Document.GetElementByID("GT81rJIJrrd-iZDhpMYrUhD-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALK10")
...
IE.Document.GetElementByID("GT81rJIJrrd-RX6Bt5WZBTp-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALL10")
...
IE.Document.GetElementByID("GT81rJIJrrd-mm3OwXbMrDO-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALM10")
...
IE.Document.GetElementByID("GT81rJIJrrd-qbvstlhbKQN-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALN10")
...
IE.Document.GetElementByID("GT81rJIJrrd-DWK907m2A1w-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALO10")
...
IE.Document.GetElementByID("GT81rJIJrrd-nL4Hn7rQRkH-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALP10")
...
IE.Document.GetElementByID("GT81rJIJrrd-NDSiHWlZgdn-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALQ10")
...
IE.Document.GetElementByID("GT81rJIJrrd-t6SVZj25Y51-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALR10")
...
IE.Document.GetElementByID("GT81rJIJrrd-rZkSjF483iM-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALS10")
...
IE.Document.GetElementByID("GT81rJIJrrd-FAVPrIMm5hQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALT10")
...
IE.Document.GetElementByID("GT81rJIJrrd-FAw0peqrDtE-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALU10")
...
IE.Document.GetElementByID("GT81rJIJrrd-n1vpOIvT6Xv-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALV10")
...
IE.Document.GetElementByID("GT81rJIJrrd-h0g9DokFKAZ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALW10")
...
IE.Document.GetElementByID("GT81rJIJrrd-IpGAJ8qpFHU-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALX10")
...
IE.Document.GetElementByID("GT81rJIJrrd-ba5JcnE1DUJ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALY10")
...
IE.Document.GetElementByID("GT81rJIJrrd-RK5FpyT6bYE-val").Value = ThisWorkbook.Sheets("sheet1").Range("ALZ10")
...
IE.Document.GetElementByID("GT81rJIJrrd-uRHqJGCDJgi-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMA10")
...
IE.Document.GetElementByID("GT81rJIJrrd-CHWnztu6NhK-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMB10")
...
IE.Document.GetElementByID("GT81rJIJrrd-YKar5VC8roP-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMC10")
...
IE.Document.GetElementByID("GT81rJIJrrd-bIuKoX80N2Z-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMD10")
...
IE.Document.GetElementByID("GT81rJIJrrd-KQErAdoXLqV-val").Value = ThisWorkbook.Sheets("sheet1").Range("AME10")
...
IE.Document.GetElementByID("GT81rJIJrrd-UE87jwNYjtB-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMF10")
...
IE.Document.GetElementByID("GT81rJIJrrd-d4eyjtfMJjV-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMG10")
...
IE.Document.GetElementByID("GT81rJIJrrd-TtarAq69fxc-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMH10")
...
IE.Document.GetElementByID("GT81rJIJrrd-I6c24vig2M7-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMI10")
...
IE.Document.GetElementByID("GT81rJIJrrd-ZjLjyxbIXcD-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMJ10")
...
IE.Document.GetElementByID("GT81rJIJrrd-CQQuvHn7dJa-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMK10")
...
IE.Document.GetElementByID("GT81rJIJrrd-NRQe2llLF96-val").Value = ThisWorkbook.Sheets("sheet1").Range("AML10")
...
IE.Document.GetElementByID("owIr2CJUbwq-sjNNy0f1X7D-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMM10")
...
IE.Document.GetElementByID("owIr2CJUbwq-v8fxZD3T83S-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMN10")
...
IE.Document.GetElementByID("owIr2CJUbwq-inZOMc3H9rs-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMO10")
...
IE.Document.GetElementByID("owIr2CJUbwq-xTOWzqp35pE-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMP10")
...
IE.Document.GetElementByID("owIr2CJUbwq-BepIh8WFKdy-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMQ10")
...
IE.Document.GetElementByID("owIr2CJUbwq-PmPf5Baevie-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMR10")
...
IE.Document.GetElementByID("owIr2CJUbwq-uAxwBfK44jM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMS10")
...
IE.Document.GetElementByID("owIr2CJUbwq-zOgyHZqFRfd-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMT10")
...
IE.Document.GetElementByID("owIr2CJUbwq-QYqTPplzqyH-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMU10")
...
IE.Document.GetElementByID("owIr2CJUbwq-DpcmJovCBpx-val").Value = ThisWorkbook.Sheets("sheet1").Range("AMV10")
...
IE.Document.GetElementByID("Duf3Ks5vfNL-BbOgaCiB7BE-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANG10")
...
IE.Document.GetElementByID("Duf3Ks5vfNL-wboZw8GvF3V-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANH10")
...
IE.Document.GetElementByID("Duf3Ks5vfNL-SthWYE5e0FG-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANI10")
...
IE.Document.GetElementByID("Duf3Ks5vfNL-CPooeOVlJA4-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANJ10")
...
IE.Document.GetElementByID("Duf3Ks5vfNL-lsOHpBFk3Nn-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANK10")
...
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ANL10")) Then
'Denominator
IE.Document.GetElementByID("jskukqOhI5M-HllvX50cXC0-val").Focus
IE.Document.GetElementByID("jskukqOhI5M-HllvX50cXC0-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANL10")
...
IE.Document.GetElementByID("KYjkpApPVjU-XXVM3fPoj9N-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANN10")
...
IE.Document.GetElementByID("KYjkpApPVjU-Jz2ibrOD00K-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANO10")
...
IE.Document.GetElementByID("KYjkpApPVjU-CWMkQRQI2Rj-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANP10")
...
IE.Document.GetElementByID("KYjkpApPVjU-n2lC5CRLwnR-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANQ10")
...
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ANS10")) Then
'.............................
...
IE.Document.GetElementByID("fv2OMXMwnJA-mkOfrTuz7tS-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANS10")
...
IE.Document.GetElementByID("fv2OMXMwnJA-VYMJrOJU5rQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANT10")
...
IE.Document.GetElementByID("fv2OMXMwnJA-T1jZtIrfVkq-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANU10")
...
IE.Document.GetElementByID("fv2OMXMwnJA-oaRfTQD4RLG-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANV10")
...
IE.Document.GetElementByID("fv2OMXMwnJA-itxIkeWqiE9-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANW10")
...
IE.Document.GetElementByID("fv2OMXMwnJA-a9N5X73zhET-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANX10")
...
IE.Document.GetElementByID("fv2OMXMwnJA-wKH5X6oHquw-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANY10")
...
IE.Document.GetElementByID("XL1jnbmgXje-lcEoncRc5Yt-val").Value = ThisWorkbook.Sheets("sheet1").Range("ANZ10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-lcEoncRc5Yt-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOA10")
...
IE.Document.GetElementByID("XL1jnbmgXje-j53J4R7GFQV-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOB10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-j53J4R7GFQV-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOC10")
...
IE.Document.GetElementByID("XL1jnbmgXje-amcMmQaGHZ0-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOD10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-amcMmQaGHZ0-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOE10")
...
IE.Document.GetElementByID("XL1jnbmgXje-npLVwj9uAPF-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOF10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-npLVwj9uAPF-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOG10")
...
IE.Document.GetElementByID("XL1jnbmgXje-daiD4uNdH0M-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOH10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-daiD4uNdH0M-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOI10")
...
IE.Document.GetElementByID("XL1jnbmgXje-HyBf938HWMD-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOJ10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-HyBf938HWMD-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOK10")
...
IE.Document.GetElementByID("XL1jnbmgXje-UJS3zRPmYdr-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOL10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-UJS3zRPmYdr-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOM10")
...
IE.Document.GetElementByID("XL1jnbmgXje-jmxwyRzR8lM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AON10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-jmxwyRzR8lM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOO10")
...
IE.Document.GetElementByID("XL1jnbmgXje-RUuS9eTCv09-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOP10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-RUuS9eTCv09-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOQ10")
...
IE.Document.GetElementByID("XL1jnbmgXje-Ktp5As6zWxl-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOR10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-Ktp5As6zWxl-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOS10")
...
IE.Document.GetElementByID("XL1jnbmgXje-rMgmbJPMxw2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOT10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-rMgmbJPMxw2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOU10")
...
IE.Document.GetElementByID("XL1jnbmgXje-cskUzbj4asc-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOV10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-cskUzbj4asc-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOW10")
...
IE.Document.GetElementByID("XL1jnbmgXje-iAQmGQJLuJi-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOX10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-iAQmGQJLuJi-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOY10")
...
IE.Document.GetElementByID("XL1jnbmgXje-Os4enuLPVkA-val").Value = ThisWorkbook.Sheets("sheet1").Range("AOZ10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-Os4enuLPVkA-val").Value = ThisWorkbook.Sheets("sheet1").Range("APA10")
...
IE.Document.GetElementByID("XL1jnbmgXje-nt6Mv9rOBFP-val").Value = ThisWorkbook.Sheets("sheet1").Range("APB10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-nt6Mv9rOBFP-val").Value = ThisWorkbook.Sheets("sheet1").Range("APC10")
...
IE.Document.GetElementByID("XL1jnbmgXje-xh2pAMw81mS-val").Value = ThisWorkbook.Sheets("sheet1").Range("APD10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-xh2pAMw81mS-val").Value = ThisWorkbook.Sheets("sheet1").Range("APE10")
...
IE.Document.GetElementByID("XL1jnbmgXje-z8uoJOcMd8n-val").Value = ThisWorkbook.Sheets("sheet1").Range("APF10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-z8uoJOcMd8n-val").Value = ThisWorkbook.Sheets("sheet1").Range("APG10")
...
IE.Document.GetElementByID("XL1jnbmgXje-CXYUkjSk3gC-val").Value = ThisWorkbook.Sheets("sheet1").Range("APH10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-CXYUkjSk3gC-val").Value = ThisWorkbook.Sheets("sheet1").Range("API10")
...
IE.Document.GetElementByID("XL1jnbmgXje-PDCEdxrmbWc-val").Value = ThisWorkbook.Sheets("sheet1").Range("APJ10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-PDCEdxrmbWc-val").Value = ThisWorkbook.Sheets("sheet1").Range("APK10")
...
IE.Document.GetElementByID("XL1jnbmgXje-r8CF58PRLMk-val").Value = ThisWorkbook.Sheets("sheet1").Range("APL10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-r8CF58PRLMk-val").Value = ThisWorkbook.Sheets("sheet1").Range("APM10")
...
IE.Document.GetElementByID("XL1jnbmgXje-YAofbwYDMFf-val").Value = ThisWorkbook.Sheets("sheet1").Range("APN10")
...
IE.Document.GetElementByID("yoxGr2OW5vT-YAofbwYDMFf-val").Value = ThisWorkbook.Sheets("sheet1").Range("APO10")
...
evt.initEvent "change", True, False
'LAB_Based
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("APU10")) Then
'HIV Serology/Diagnostic Testing
IE.Document.GetElementByID("mJONpM4NS83-wjvrjctVIFl-val").Focus
IE.Document.GetElementByID("mJONpM4NS83-wjvrjctVIFl-val").Value = ThisWorkbook.Sheets("sheet1").Range("APU10")
...
IE.Document.GetElementByID("mJONpM4NS83-dvzWOOwlCTL-val").Value = ThisWorkbook.Sheets("sheet1").Range("APV10")
...
IE.Document.GetElementByID("mJONpM4NS83-bBYFupWkFv5-val").Value = ThisWorkbook.Sheets("sheet1").Range("APW10")
...
IE.Document.GetElementByID("mJONpM4NS83-kvmsInuJ6Rm-val").Value = ThisWorkbook.Sheets("sheet1").Range("APX10")
...
IE.Document.GetElementByID("mJONpM4NS83-fgc78xUuXYN-val").Value = ThisWorkbook.Sheets("sheet1").Range("APY10")
...
IE.Document.GetElementByID("mJONpM4NS83-Jf9Wcow932c-val").Value = ThisWorkbook.Sheets("sheet1").Range("APZ10")
...
IE.Document.GetElementByID("mJONpM4NS83-gCzhExxbNYd-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQA10")
...
IE.Document.GetElementByID("mJONpM4NS83-bKFJOpx3RRG-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQB10")
...
IE.Document.GetElementByID("mJONpM4NS83-agGmRAeaZiV-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQC10")
...
IE.Document.GetElementByID("mJONpM4NS83-Z0qfOiODpLT-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQD10")
...
IE.Document.GetElementByID("mJONpM4NS83-ss1UjocOpi8-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQE10")
...
IE.Document.GetElementByID("mJONpM4NS83-g2onz7XRaAN-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQF10")
...
IE.Document.GetElementByID("mJONpM4NS83-ZahS9NJoKXW-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQG10")
...
IE.Document.GetElementByID("mJONpM4NS83-aU6B7ARLC5D-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQH10")
...
IE.Document.GetElementByID("mJONpM4NS83-Pq31JMqCwCh-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQI10")
...
IE.Document.GetElementByID("mJONpM4NS83-HN71aSgygm2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQJ10")
...
IE.Document.GetElementByID("mJONpM4NS83-WBmklDDpMK9-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQK10")
...
IE.Document.GetElementByID("mJONpM4NS83-PwYC0dYJTi0-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQL10")
...
IE.Document.GetElementByID("mJONpM4NS83-NW9C5LxQSaw-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQM10")
...
IE.Document.GetElementByID("mJONpM4NS83-BC8M2tzZuzK-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQN10")
...
IE.Document.GetElementByID("mJONpM4NS83-mBqCymU7iDH-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQO10")
...
IE.Document.GetElementByID("mJONpM4NS83-HbburZGhdc6-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQP10")
...
IE.Document.GetElementByID("mJONpM4NS83-PEmcDc3l3Ma-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQQ10")
...
IE.Document.GetElementByID("mJONpM4NS83-hro5eQVT06z-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQR10")
...
IE.Document.GetElementByID("mJONpM4NS83-w97PFBrriFb-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQS10")
...
IE.Document.GetElementByID("mJONpM4NS83-EUngOIhkk2K-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQT10")
...
IE.Document.GetElementByID("mJONpM4NS83-Xgy1dZs6LpY-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQU10")
...
IE.Document.GetElementByID("mJONpM4NS83-BHOcyZmY4KV-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQV10")
...
IE.Document.GetElementByID("mJONpM4NS83-on7sWkx3GcK-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQW10")
...
IE.Document.GetElementByID("mJONpM4NS83-tWUeCanlxoS-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQX10")
...
IE.Document.GetElementByID("mJONpM4NS83-xk7MyebpXBb-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQY10")
...
IE.Document.GetElementByID("mJONpM4NS83-PeDDjUaHEJS-val").Value = ThisWorkbook.Sheets("sheet1").Range("AQZ10")
IE.Document.GetElementByID("mJONpM4NS83-PeDDjUaHEJS-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))
End If
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ARA10")) Then
'2
'HIV Serology/Diagnostic Testing
IE.Document.GetElementByID("ifqUg8hufqa-M5ETn6L06TX-val").Focus
IE.Document.GetElementByID("ifqUg8hufqa-M5ETn6L06TX-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARA10")
...
IE.Document.GetElementByID("ifqUg8hufqa-yqP8sdEslHe-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARB10")
...
IE.Document.GetElementByID("ifqUg8hufqa-SwijqDKg39a-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARC10")
...
IE.Document.GetElementByID("ifqUg8hufqa-fPsjgJS4Y1b-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARD10")
...
IE.Document.GetElementByID("ifqUg8hufqa-yARDsUl7jL2-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARE10")
...
IE.Document.GetElementByID("ifqUg8hufqa-kPseq1szL7a-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARF10")
...
IE.Document.GetElementByID("ifqUg8hufqa-lx8MrZoeqbu-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARG10")
...
IE.Document.GetElementByID("ifqUg8hufqa-pgOsuoYuuqI-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARH10")
...
IE.Document.GetElementByID("ifqUg8hufqa-Md2wJHpfZLS-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARI10")
...
IE.Document.GetElementByID("ifqUg8hufqa-ateI9jWePpi-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARJ10")
...
IE.Document.GetElementByID("ifqUg8hufqa-MO0XrsKbX5s-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARK10")
...
IE.Document.GetElementByID("ifqUg8hufqa-ZlaikKV6Fjb-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARL10")
...
IE.Document.GetElementByID("ifqUg8hufqa-OZ7ZpzpRDOG-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARM10")
...
IE.Document.GetElementByID("ifqUg8hufqa-bME9lhrNZw2-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARN10")
...
IE.Document.GetElementByID("ifqUg8hufqa-ro8CgNFng17-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARO10")
...
IE.Document.GetElementByID("ifqUg8hufqa-XdD5EAst7OH-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARP10")
...
IE.Document.GetElementByID("ifqUg8hufqa-tp3PpSM67pw-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARQ10")
...
IE.Document.GetElementByID("ifqUg8hufqa-m7YxHE5TgAv-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARR10")
...
IE.Document.GetElementByID("ifqUg8hufqa-LxXClsdXZgg-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARS10")
...
IE.Document.GetElementByID("ifqUg8hufqa-kU09A3lqJDR-val").Value = ThisWorkbook.Sheets("sheet1").Range("ART10")
...
IE.Document.GetElementByID("ifqUg8hufqa-oXNvAdTPZXb-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARU10")
...
IE.Document.GetElementByID("ifqUg8hufqa-og3bd0Ph8nj-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARV10")
...
IE.Document.GetElementByID("ifqUg8hufqa-hjobBGwqCQp-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARW10")
...
IE.Document.GetElementByID("ifqUg8hufqa-PMUw1K3ybr5-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARX10")
...
IE.Document.GetElementByID("iCBrw4jfZpW-oCr3aOvULR9-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARY10")
...
IE.Document.GetElementByID("iCBrw4jfZpW-lyLlOQn9Fp2-val").Value = ThisWorkbook.Sheets("sheet1").Range("ARZ10")
...
IE.Document.GetElementByID("iCBrw4jfZpW-wROfCcdTvss-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASA10")
...
IE.Document.GetElementByID("iCBrw4jfZpW-hL4XtxFcUly-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASB10")
...
IE.Document.GetElementByID("iCBrw4jfZpW-YMEVFWa9k4c-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASC10")
...
IE.Document.GetElementByID("iCBrw4jfZpW-ErICyBbbakd-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASD10")
...
IE.Document.GetElementByID("iCBrw4jfZpW-SowytNTBD0k-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASE10")
...
IE.Document.GetElementByID("iCBrw4jfZpW-oKmaZM3W8u4-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASF10")
IE.Document.GetElementByID("iCBrw4jfZpW-oKmaZM3W8u4-val").dispatchEvent evt
Application.Wait Now + TimeValue("00:00:0" & Int((5 - 2 + 1) * Rnd + 2))
End If
'POCT_Based
If Not IsEmpty(ThisWorkbook.Sheets("sheet1").Range("ASG10")) Then
'HIV Serology/Diagnostic Testing
IE.Document.GetElementByID("kIec9Ct3rmW-hInFtmuzHDf-val").Focus
IE.Document.GetElementByID("kIec9Ct3rmW-hInFtmuzHDf-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASG10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-nfUIRf3FMoC-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASH10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-OMV9exs4Jwh-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASI10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-zSBp3PaZbyV-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASJ10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-GTYD2Jz4jy9-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASK10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-HEE8IQsRKSH-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASL10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-WZjzgiQNVQG-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASM10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-f3Fp4ZcpgUE-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASN10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-RLhCaY19QGX-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASO10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-ldFSGD0yoXI-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASP10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-VVws7Bnkxj2-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASQ10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-Ee6RJqyoaND-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASR10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-vk0up5uA22L-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASS10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-t0X7kuP5ITu-val").Value = ThisWorkbook.Sheets("sheet1").Range("AST10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-gBHiHjh867b-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASU10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-JYRrkeyoS5K-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASV10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-LVKpFMHDCVS-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASW10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-uZxKzmy1gT9-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASX10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-W3BCOcida7x-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASY10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-jGeWA56aMyU-val").Value = ThisWorkbook.Sheets("sheet1").Range("ASZ10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-cywAcu4UVW0-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATA10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-fLz6DbRk6Mw-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATB10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-lrhlvZHtWX9-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATC10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-BNw9GNp6tV5-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATD10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-ZUVlmJ1164I-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATE10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-gwHKAKHznIt-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATF10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-KyAYHU2FTyY-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATG10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-cITP8LkNcAj-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATH10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-Y6uJrlohWwk-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATI10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-YrJMntMq0oI-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATJ10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-ZnmN6tgY0NQ-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATK10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-AYmLMcikVrX-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATL10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-lehXF1LRHqA-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATM10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-r0xdQ7Kp8Eq-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATN10")
...
IE.Document.GetElementByID("kIec9Ct3rmW-I8X0GYqzTeR-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATO10")
...
IE.Document.GetElementByID("bHk1JDK2258-WTwRddezAcN-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATP10")
...
IE.Document.GetElementByID("bHk1JDK2258-OiQAT4scJab-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATQ10")
...
IE.Document.GetElementByID("bHk1JDK2258-FmtEs0FhrI3-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATR10")
...
IE.Document.GetElementByID("bHk1JDK2258-x1ZhynBLOIi-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATS10")
...
IE.Document.GetElementByID("bHk1JDK2258-cPzQeUyMQZc-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATT10")
...
IE.Document.GetElementByID("bHk1JDK2258-oX3ldNgOeUH-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATU10")
...
IE.Document.GetElementByID("bHk1JDK2258-ODKM7OHCRjz-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATV10")
...
IE.Document.GetElementByID("bHk1JDK2258-PFkP1b4ANZq-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATW10")
...
IE.Document.GetElementByID("bHk1JDK2258-xhmIGOSW30y-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATX10")
...
IE.Document.GetElementByID("bHk1JDK2258-vR29RErQpWn-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATY10")
...
IE.Document.GetElementByID("bHk1JDK2258-yY9Dl2GZnP7-val").Value = ThisWorkbook.Sheets("sheet1").Range("ATZ10")
...
IE.Document.GetElementByID("bHk1JDK2258-hFUic9x0Ouq-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUA10")
...
IE.Document.GetElementByID("bHk1JDK2258-aaGH9ISti24-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUB10")
...
IE.Document.GetElementByID("bHk1JDK2258-YHLx3VeYEcV-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUC10")
...
IE.Document.GetElementByID("bHk1JDK2258-smN1gR96NfR-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUD10")
...
IE.Document.GetElementByID("bHk1JDK2258-xj65GAubNL7-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUE10")
...
IE.Document.GetElementByID("bHk1JDK2258-onZfonByj2s-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUF10")
...
IE.Document.GetElementByID("bHk1JDK2258-RpONrp3gGku-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUG10")
...
IE.Document.GetElementByID("bHk1JDK2258-d3BHuxTH1cp-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUH10")
...
IE.Document.GetElementByID("bHk1JDK2258-jT7bpHN3WlM-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUI10")
...
IE.Document.GetElementByID("bHk1JDK2258-CKlcawPMejd-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUJ10")
...
IE.Document.GetElementByID("KMtAtCRNZl8-oCr3aOvULR9-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUK10")
...
IE.Document.GetElementByID("KMtAtCRNZl8-lyLlOQn9Fp2-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUL10")
...
IE.Document.GetElementByID("KMtAtCRNZl8-wROfCcdTvss-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUM10")
...
IE.Document.GetElementByID("KMtAtCRNZl8-hL4XtxFcUly-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUN10")
...
IE.Document.GetElementByID("KMtAtCRNZl8-YMEVFWa9k4c-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUO10")
...
IE.Document.GetElementByID("KMtAtCRNZl8-SowytNTBD0k-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUP10")
...
IE.Document.GetElementByID("KMtAtCRNZl8-oKmaZM3W8u4-val").Value = ThisWorkbook.Sheets("sheet1").Range("AUQ10")
